...
static s16 scenario_text_0126[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_t, CHR_h, CHR_e, PCT_SPACE, PCT_LBRACKET, CTR_EM_YELLOW, CHR_F,
    CHR_l, CHR_y, CHR_i, CHR_n, CHR_g, CTR_CLOSE_EM, PCT_RBRACKET, PCT_SPACE, CHR_m, CHR_a,
    CHR_g, CHR_i, CHR_c, PCT_SPACE, CHR_p, CHR_o, CHR_w, CHR_e, CHR_r, CHR_s,
    PCT_EXCLAMATION, CTR_NEWLINE, CTR_ENDLINE
};

// {button}{endline}
static s16 scenario_text_0169[] = {
    CTR_BUTTON, CTR_ENDLINE
};

// {newwindow}{endline}
static s16 scenario_text_017E[] = {
    CTR_NEWWINDOW, CTR_ENDLINE
};
...
s32 scenario_code_message_17a_3650[] = {
    ...
    // 3730: Print Text
    TXT, (s32)&scenario_text_00EA,

    // 3738: Print Text
    TXT, (s32)&scenario_text_0102,

    // 3740: Print Text
    TXT, (s32)&scenario_text_0126,
    ...
    // 37a8: Print Text
    TXT, (s32)&scenario_text_0196,

    // 37b0: Print Text
    TXT, (s32)&scenario_text_01DA,
