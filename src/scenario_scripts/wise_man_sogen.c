...
static s16 scenario_text_00E1[] = {
    ...
    CHR_o, PCT_SPACE, CTR_EM_YELLOW, PCT_LBRACKET, CHR_L, CHR_e, CHR_v, CHR_e, CHR_l, PCT_SPACE,
    NUM_3, PCT_RBRACKET, CTR_CLOSE_EM, PCT_EXCLAMATION, CTR_NEWLINE, CTR_ENDLINE
};

// {button}{endline}
static s16 scenario_text_0127[] = {
    CTR_BUTTON, CTR_ENDLINE
};

// {newwindow}{endline}
static s16 scenario_text_013C[] = {
    CTR_NEWWINDOW, CTR_ENDLINE
};

//  {newline}{endline}
static s16 scenario_text_0154[] = {
...
static s16 scenario_text_01A4[] = {
    CHR_e, CHR_v, CHR_e, CHR_n, PCT_SPACE, CHR_r, CHR_i, CHR_g, CHR_i, CHR_d,
    PCT_SPACE, CTR_EM_YELLOW, CHR_d, CHR_o, CHR_o, CHR_r, CHR_s, CTR_CLOSE_EM, PCT_SPACE, CHR_c,
    CHR_a, CHR_n, PCT_SPACE, CHR_b, CHR_e, PCT_SPACE, CHR_d, CHR_e, CHR_s, CHR_t,
    CHR_r, CHR_o, CHR_y, CHR_e, CHR_d, PCT_EXCLAMATION, CTR_BUTTON, CTR_END, CTR_ENDLINE
};

// {begin}{endline}
static s16 scenario_text_01F0[] = {
    CTR_BEGIN, CTR_ENDLINE
};
...
s32 scenario_code_message_227_3a14[] = {
    ...
    // 3af4: Print Text
    TXT, (s32)&scenario_text_00A9,

    // 3afc: Print Text
    TXT, (s32)&scenario_text_00E1,
    ...
    // 3b34: Print Text
    TXT, (s32)&scenario_text_0127,

    // 3b3c: Print Text
    TXT, (s32)&scenario_text_013C,

    // 3b44: Print Text
    TXT, (s32)&scenario_text_0154,

    // 3b4c: Print Text
    TXT, (s32)&scenario_text_016B,

    // 3b54: Print Text
    TXT, (s32)&scenario_text_01A4,
