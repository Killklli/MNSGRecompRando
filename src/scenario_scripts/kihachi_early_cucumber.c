...
static s16 scenario_text_0014[] = {
    ...
    PCT_COLON, CHR_A, CHR_l, CHR_l, PCT_SPACE, CHR_r, CHR_i,
    CHR_g, CHR_h, CHR_t, PCT_EXCLAMATION, CTR_NEWLINE, CTR_ENDLINE};
...
static s16 scenario_text_003C[] = {
    ...
    CHR_I, PCT_APOSTROPHE, CHR_l, CHR_l, PCT_SPACE, CHR_g,
    CHR_i, CHR_v, CHR_e, PCT_SPACE, CHR_i, CHR_t,
    PCT_SPACE, CHR_t, CHR_o, PCT_SPACE, CHR_y, CHR_o,
...
static s16 scenario_text_006B[] = {
    ...
    PCT_SPACE, CHR_b, CHR_r, CHR_i, CHR_n, CHR_g,
    PCT_SPACE, CHR_m, CHR_e, CTR_NEWLINE, CTR_ENDLINE};

//       my {em-yellow}favorite food{/em}.{button}{end}{endline}
static s16 scenario_text_0096[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    CHR_m, CHR_y, PCT_SPACE, CTR_EM_YELLOW, CHR_f, CHR_a,
    CHR_v, CHR_o, CHR_r, CHR_i, CHR_t, CHR_e,
    PCT_SPACE, CHR_f, CHR_o, CHR_o, CHR_d, CTR_CLOSE_EM,
    PCT_PERIOD, CTR_BUTTON, CTR_END, CTR_ENDLINE};

// {begin}{endline}
static s16 scenario_text_00D7[] = {CTR_BEGIN, CTR_ENDLINE};
...
static s16 scenario_text_00EB[] = {
    ...
    CHR_a, CHR_r, CHR_u, PCT_COLON, CHR_Y, CHR_o,
    CHR_u, CHR_r, PCT_SPACE, CTR_EM_YELLOW, CHR_f, CHR_a,
    CHR_v, CHR_o, CHR_u, CHR_r, CHR_i, CHR_t,
    CHR_e, PCT_SPACE, CHR_f, CHR_o, CHR_o, CHR_d,
    CTR_CLOSE_EM, PCT_QUESTION, CTR_BUTTON, CTR_END, CTR_ENDLINE};

// {begin}{endline}
static s16 scenario_text_0133[] = {CTR_BEGIN, CTR_ENDLINE};

// Kihachi:Yes! {newline}{endline}
static s16 scenario_text_0147[] = {
    CHR_K, CHR_i, CHR_h, CHR_a, CHR_c,
    CHR_h, CHR_i, PCT_COLON, CHR_Y, CHR_e,
...
static s16 scenario_text_016A[] = {
    ...
    PCT_SPACE, CTR_EM_YELLOW, CHR_M, CHR_y, PCT_SPACE,
    CHR_f, CHR_a, CHR_v, CHR_o, CHR_u,
    CHR_r, CHR_i, CHR_t, CHR_e, PCT_SPACE,
    CHR_f, CHR_o, CHR_o, CHR_d, CTR_CLOSE_EM,
    PCT_EXCLAMATION, CTR_BUTTON, CTR_ENDLINE};

// {newwindow}{endline}
static s16 scenario_text_01A7[] = {CTR_NEWWINDOW, CTR_ENDLINE};
...
static s16 scenario_text_01DD[] = {CTR_WAITINPUT, CTR_END, CTR_ENDLINE};
...
// {end}{endline}
static s16 scenario_text_0000b0[] = {CTR_END, CTR_ENDLINE};
...
// {button}{end}{endline}
static s16 scenario_text_008ee8[] = {CTR_BUTTON, CTR_END, CTR_ENDLINE};
...
s32 scenario_code_message_163_d320[] = {
    ...
    // d508: Print Text
    TXT,
    (s32)&scenario_text_009154,

    // d510: Print Text
    TXT,
    (s32)&scenario_text_009194,

    // d518: Print Text
    TXT,
    (s32)&scenario_text_0091c8,
    ...
    // d588: Print Text
    TXT,
    (s32)&scenario_text_005e8c,

    // d590: Print Text
    TXT,
    (s32)&scenario_text_009204,

    // d598: Print Text
    TXT,
    (s32)&scenario_text_009248,
    ...
    // d628: Print Text
    TXT,
    (s32)&scenario_text_009058,

    // d630: Print Text
    TXT,
    (s32)&scenario_text_008ee8,
