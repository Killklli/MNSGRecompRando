...
static s16 scenario_text_002B[] = {
    PCT_SPACE, PCT_SPACE, CHR_G, CHR_o, CHR_e, CHR_m, CHR_o, CHR_n, PCT_SPACE, CHR_r,
    CHR_e, CHR_c, CHR_e, CHR_i, CHR_v, CHR_e, CHR_s, CTR_NEWLINE, CTR_ENDLINE
};

//      the {em-yellow}Medal of Flames{/em}!{endline}
static s16 scenario_text_0060[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_t, CHR_h, CHR_e, PCT_SPACE, CTR_EM_YELLOW,
    PCT_LBRACKET, CHR_M, CHR_e, CHR_d, CHR_a, CHR_l, PCT_SPACE, CHR_o, CHR_f, PCT_SPACE,
    CHR_F, CHR_l, CHR_a, CHR_m, CHR_e, CHR_s, PCT_RBRACKET, CTR_CLOSE_EM, PCT_EXCLAMATION, CTR_ENDLINE
};

// {button}{endline}
static s16 scenario_text_00A7[] = {
    CTR_BUTTON, CTR_ENDLINE
};

// {newwindow}{endline}
static s16 scenario_text_00B9[] = {
    CTR_NEWWINDOW, CTR_ENDLINE
};

//   {newline}{endline}
static s16 scenario_text_00D1[] = {
    PCT_SPACE, PCT_SPACE, CTR_NEWLINE, CTR_ENDLINE
};

// By continuously holding down{newline}{endline}
static s16 scenario_text_00E8[] = {
    CHR_B, CHR_y, PCT_SPACE, CHR_c, CHR_o, CHR_n, CHR_t, CHR_i, CHR_n, CHR_u,
    CHR_o, CHR_u, CHR_s, CHR_l, CHR_y, PCT_SPACE, CHR_h, CHR_o, CHR_l, CHR_d,
    CHR_i, CHR_n, CHR_g, PCT_SPACE, CHR_d, CHR_o, CHR_w, CHR_n, CTR_NEWLINE, CTR_ENDLINE
};

// the {em-yellow}B Button{/em} and then letting go...{button}{endline}
static s16 scenario_text_0124[] = {
    CHR_t, CHR_h, CHR_e, PCT_SPACE, CTR_EM_YELLOW, CHR_B, PCT_SPACE, CHR_B, CHR_u, CHR_t,
    CHR_t, CHR_o, CHR_n, CTR_CLOSE_EM, PCT_SPACE, CHR_a, CHR_n, CHR_d, PCT_SPACE, CHR_t,
    CHR_h, CHR_e, CHR_n, PCT_SPACE, CHR_l, CHR_e, CHR_t, CHR_t, CHR_i, CHR_n,
    CHR_g, PCT_SPACE, CHR_g, CHR_o, PCT_PERIOD, PCT_PERIOD, PCT_PERIOD, CTR_BUTTON, CTR_ENDLINE
};

// a powerful {em-yellow}medal{/em} surrounded by{newline}{endline}
static s16 scenario_text_0174[] = {
    CHR_a, PCT_SPACE, CHR_p, CHR_o, CHR_w, CHR_e, CHR_r, CHR_f, CHR_u, CHR_l,
    PCT_SPACE, CTR_EM_YELLOW, CHR_m, CHR_e, CHR_d, CHR_a, CHR_l, CTR_CLOSE_EM, PCT_SPACE, CHR_s,
    CHR_u, CHR_r, CHR_r, CHR_o, CHR_u, CHR_n, CHR_d, CHR_e, CHR_d, PCT_SPACE,
    CHR_b, CHR_y, CTR_NEWLINE, CTR_ENDLINE
};

// {em-yellow}flames{/em} will be thrown!{newline}{endline}
static s16 scenario_text_01B8[] = {
    CTR_EM_YELLOW, CHR_f, CHR_l, CHR_a, CHR_m, CHR_e, CHR_s, CTR_CLOSE_EM, PCT_SPACE, CHR_w,
    CHR_i, CHR_l, CHR_l, PCT_SPACE, CHR_b, CHR_e, PCT_SPACE, CHR_t, CHR_h, CHR_r,
    CHR_o, CHR_w, CHR_n, PCT_EXCLAMATION, CTR_NEWLINE, CTR_ENDLINE
};

// (The {em-yellow}torch{/em} can also be lit{newline}{endline}
static s16 scenario_text_01EC[] = {
    PCT_LPAREN, CHR_T, CHR_h, CHR_e, PCT_SPACE, CTR_EM_YELLOW, CHR_t, CHR_o, CHR_r, CHR_c,
    CHR_h, CTR_CLOSE_EM, PCT_SPACE, CHR_c, CHR_a, CHR_n, PCT_SPACE, CHR_a, CHR_l, CHR_s,
    CHR_o, PCT_SPACE, CHR_b, CHR_e, PCT_SPACE, CHR_l, CHR_i, CHR_t, CTR_NEWLINE, CTR_ENDLINE
};
...
static s16 scenario_text_022C[] = {
    ...
    PCT_SPACE, PCT_SPACE, CHR_b, CHR_y, PCT_SPACE, CHR_u, CHR_s, CHR_i, CHR_n, CHR_g,
    PCT_SPACE, CHR_t, CHR_h, CHR_i, CHR_s, PCT_RPAREN, CTR_ENDLINE
};
...
s32 scenario_code_message_082_36e0[] = {
    ...
    // 37a8: Print Text
    TXT, (s32)&scenario_text_00A7,

    // 37b0: Print Text
    TXT, (s32)&scenario_text_00B9,
    ...
    // 37d8: Print Text
    TXT, (s32)&scenario_text_00D1,

    // 37e0: Print Text
    TXT, (s32)&scenario_text_00E8,

    // 37e8: Print Text
    TXT, (s32)&scenario_text_0124,

    // 37f0: Print Text
    TXT, (s32)&scenario_text_00B9,

    // 37f8: Print Text
    TXT, (s32)&scenario_text_0174,

    // 3800: Print Text
    TXT, (s32)&scenario_text_01B8,

    // 3808: Print Text
    TXT, (s32)&scenario_text_01EC,

    // 3810: Print Text
    TXT, (s32)&scenario_text_022C,
