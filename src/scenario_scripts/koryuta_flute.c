...
static s16 scenario_text_0014[] = {
    ...
    CHR_i, CHR_s, PCT_SPACE, CHR_t, CHR_h, CHR_i,
    CHR_s, PCT_SPACE, CTR_EM_YELLOW, CHR_f, CHR_l, CHR_u,
    CHR_t, CHR_e, CTR_CLOSE_EM, PCT_QUESTION, CTR_BUTTON, CTR_END,
    CTR_ENDLINE};

// {begin}{endline}
static s16 scenario_text_0058[] = {CTR_BEGIN, CTR_ENDLINE};

// Koryuta:At any time,{newline}{endline}
static s16 scenario_text_006C[] = {
    CHR_K, CHR_o, CHR_r, CHR_y, CHR_u, CHR_t,
    CHR_a, PCT_COLON, CHR_A, CHR_t, PCT_SPACE, CHR_a,
    CHR_n, CHR_y, PCT_SPACE, CHR_t, CHR_i, CHR_m,
...
static s16 scenario_text_0096[] = {
    ...
    PCT_SPACE, CHR_o, CHR_r, PCT_SPACE, CHR_a, CHR_n,
    CHR_y, PCT_SPACE, CHR_p, CHR_l, CHR_a, CHR_c,
    CHR_e, CTR_NEWLINE, CTR_ENDLINE};

//        you play that {em-yellow}flute{/em},{button}{endline}
static s16 scenario_text_00BF[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    PCT_SPACE, CHR_y, CHR_o, CHR_u, PCT_SPACE, CHR_p,
    CHR_l, CHR_a, CHR_y, PCT_SPACE, CHR_t, CHR_h,
    CHR_a, CHR_t, PCT_SPACE, CTR_EM_YELLOW, CHR_f, CHR_l,
    CHR_u, CHR_t, CHR_e, CTR_CLOSE_EM, PCT_COMMA, CTR_BUTTON,
    CTR_ENDLINE};

// {newwindow}{endline}
static s16 scenario_text_00FF[] = {CTR_NEWWINDOW, CTR_ENDLINE};

// Koryuta:I will arrive right{newline}{endline}
static s16 scenario_text_0117[] = {
    CHR_K, CHR_o, CHR_r, CHR_y, CHR_u, CHR_t,
    CHR_a, PCT_COLON, CHR_I, PCT_SPACE, CHR_w, CHR_i,
    CHR_l, CHR_l, PCT_SPACE, CHR_a, CHR_r, CHR_r,
    CHR_i, CHR_v, CHR_e, PCT_SPACE, CHR_r, CHR_i,
    CHR_g, CHR_h, CHR_t, CTR_NEWLINE, CTR_ENDLINE};

//        by your side in {em-yellow}Dragon{/em}{newline}{endline}
static s16 scenario_text_0148[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    PCT_SPACE, CHR_b, CHR_y, PCT_SPACE, CHR_y, CHR_o,
    CHR_u, CHR_r, PCT_SPACE, CHR_s, CHR_i, CHR_d,
    CHR_e, PCT_SPACE, CHR_i, CHR_n, PCT_SPACE, CTR_EM_YELLOW,
    CHR_D, CHR_r, CHR_a, CHR_g, CHR_o, CHR_n,
...
// {newwindow}{endline}
static s16 scenario_text_01AC[] = {CTR_NEWWINDOW, CTR_ENDLINE};

// Koryuta:I will take you to any{newline}{endline}
static s16 scenario_text_01C4[] = {
    CHR_K, CHR_o, CHR_r, CHR_y, CHR_u, CHR_t, CHR_a,
    PCT_COLON, CHR_I, PCT_SPACE, CHR_w, CHR_i, CHR_l, CHR_l,
    PCT_SPACE, CHR_t, CHR_a, CHR_k, CHR_e, PCT_SPACE, CHR_y,
    CHR_o, CHR_u, PCT_SPACE, CHR_t, CHR_o, PCT_SPACE, CHR_a,
    CHR_n, CHR_y, CTR_NEWLINE, CTR_ENDLINE};

//        {em-yellow}town{/em}, {em-yellow}village{/em}, {em-yellow}coffee
//        shop{/em} {newline}{endline}
static s16 scenario_text_01F8[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    PCT_SPACE, PCT_SPACE, CTR_EM_YELLOW, CHR_t, CHR_o,
    CHR_w, CHR_n, CTR_CLOSE_EM, PCT_COMMA, PCT_SPACE,
    CTR_EM_YELLOW, CHR_v, CHR_i, CHR_l, CHR_l,
    CHR_a, CHR_g, CHR_e, CTR_CLOSE_EM, PCT_COMMA,
    PCT_SPACE, CTR_EM_YELLOW, CHR_c, CHR_o, CHR_f,
    CHR_f, CHR_e, CHR_e, PCT_SPACE, CHR_s,
    CHR_h, CHR_o, CHR_p, CTR_CLOSE_EM, PCT_SPACE,
    CTR_NEWLINE, CTR_ENDLINE};

//        or {em-yellow}castle{/em} you've been to!{button}{end}{endline}
static s16 scenario_text_0260[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    PCT_SPACE, PCT_SPACE, CHR_o, CHR_r, PCT_SPACE,
    CTR_EM_YELLOW, CHR_c, CHR_a, CHR_s, CHR_t,
    CHR_l, CHR_e, CTR_CLOSE_EM, PCT_SPACE, CHR_y,
    CHR_o, CHR_u, PCT_APOSTROPHE, CHR_v, CHR_e,
    PCT_SPACE, CHR_b, CHR_e, CHR_e, CHR_n,
    PCT_SPACE, CHR_t, CHR_o, PCT_EXCLAMATION, CTR_BUTTON,
    CTR_END, CTR_ENDLINE};

// {begin}{endline}
static s16 scenario_text_02AA[] = {CTR_BEGIN, CTR_ENDLINE};

// Goemon:That would help{newline}{endline}
static s16 scenario_text_02BE[] = {
    CHR_G, CHR_o, CHR_e, CHR_m, CHR_o, CHR_n, PCT_COLON, CHR_T,
    CHR_h, CHR_a, CHR_t, PCT_SPACE, CHR_w, CHR_o, CHR_u, CHR_l,
    CHR_d, PCT_SPACE, CHR_h, CHR_e, CHR_l, CHR_p, CTR_NEWLINE, CTR_ENDLINE};

//       tremendously!{newline}{endline}
static s16 scenario_text_02EA[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    CHR_t, CHR_r, CHR_e, CHR_m, CHR_e, CHR_n,
    CHR_d, CHR_o, CHR_u, CHR_s, CHR_l, CHR_y,
    PCT_EXCLAMATION, CTR_NEWLINE, CTR_ENDLINE};

//       But, I have no idea how{newline}{endline}
static s16 scenario_text_0313[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    CHR_B, CHR_u, CHR_t, PCT_COMMA, PCT_SPACE, CHR_I,
    PCT_SPACE, CHR_h, CHR_a, CHR_v, CHR_e, PCT_SPACE,
    CHR_n, CHR_o, PCT_SPACE, CHR_i, CHR_d, CHR_e,
    CHR_a, PCT_SPACE, CHR_h, CHR_o, CHR_w, CTR_NEWLINE,
    CTR_ENDLINE};

//       to play the {em-yellow}flute{/em}...{button}{endline}
static s16 scenario_text_0346[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    CHR_t, CHR_o, PCT_SPACE, CHR_p, CHR_l, CHR_a,
    CHR_y, PCT_SPACE, CHR_t, CHR_h, CHR_e, PCT_SPACE,
    CTR_EM_YELLOW, CHR_f, CHR_l, CHR_u, CHR_t, CHR_e,
    CTR_CLOSE_EM, PCT_PERIOD, PCT_PERIOD, PCT_PERIOD, CTR_BUTTON, CTR_ENDLINE};

// {newwindow}{endline}
static s16 scenario_text_0385[] = {CTR_NEWWINDOW, CTR_ENDLINE};

// Yae:I know how to play{newline}{endline}
static s16 scenario_text_039D[] = {
    CHR_Y, CHR_a, CHR_e, PCT_COLON, CHR_I, PCT_SPACE,
    CHR_k, CHR_n, CHR_o, CHR_w, PCT_SPACE, CHR_h,
    CHR_o, CHR_w, PCT_SPACE, CHR_t, CHR_o, PCT_SPACE,
    CHR_p, CHR_l, CHR_a, CHR_y, CTR_NEWLINE, CTR_ENDLINE};

//       the flute.{button}{endline}
static s16 scenario_text_03C9[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    CHR_t, CHR_h, CHR_e, PCT_SPACE, CHR_f, CHR_l,
    CHR_u, CHR_t, CHR_e, PCT_PERIOD, CTR_BUTTON, CTR_ENDLINE};

// {newwindow}{endline}
static s16 scenario_text_03EE[] = {CTR_NEWWINDOW, CTR_ENDLINE};

// Ebisumaru:Me too!{button}{endline}
static s16 scenario_text_0406[] = {
    CHR_E, CHR_b, CHR_i, CHR_s, CHR_u, CHR_m, CHR_a,
    CHR_r, CHR_u, PCT_COLON, CHR_M, CHR_e, PCT_SPACE, CHR_t,
    CHR_o, CHR_o, PCT_EXCLAMATION, CTR_BUTTON, CTR_ENDLINE};

// {newwindow}{endline}
static s16 scenario_text_042C[] = {CTR_NEWWINDOW, CTR_ENDLINE};

// Goemon:Okay then, {em-yellow}Yae{/em},{newline}{endline}
static s16 scenario_text_0444[] = {
    CHR_G, CHR_o, CHR_e, CHR_m, CHR_o, CHR_n,
    PCT_COLON, CHR_O, CHR_k, CHR_a, CHR_y, PCT_SPACE,
    CHR_t, CHR_h, CHR_e, CHR_n, PCT_COMMA, PCT_SPACE,
    CTR_EM_YELLOW, CHR_Y, CHR_a, CHR_e, CTR_CLOSE_EM, PCT_COMMA,
    CTR_NEWLINE, CTR_ENDLINE};

//       I'll hand this flute{newline}{endline}
static s16 scenario_text_0480[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    CHR_I, PCT_APOSTROPHE, CHR_l, CHR_l, PCT_SPACE, CHR_h,
    CHR_a, CHR_n, CHR_d, PCT_SPACE, CHR_t, CHR_h,
    CHR_i, CHR_s, PCT_SPACE, CHR_f, CHR_l, CHR_u,
    CHR_t, CHR_e, CTR_NEWLINE, CTR_ENDLINE};

//       to {em-yellow}you{/em}!{button}{endline}
static s16 scenario_text_04B0[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    PCT_SPACE, CHR_t, CHR_o, PCT_SPACE, CTR_EM_YELLOW,
    CHR_y, CHR_o, CHR_u, CTR_CLOSE_EM, PCT_EXCLAMATION,
    CTR_BUTTON, CTR_ENDLINE};

// {newwindow}{endline}
static s16 scenario_text_04E2[] = {CTR_NEWWINDOW, CTR_ENDLINE};

// Ebisumaru:Why not me?!{newline}{endline}
static s16 scenario_text_04FA[] = {
    CHR_E, CHR_b, CHR_i, CHR_s, CHR_u, CHR_m,
    CHR_a, CHR_r, CHR_u, PCT_COLON, CHR_W, CHR_h,
    CHR_y, PCT_SPACE, CHR_n, CHR_o, CHR_t, PCT_SPACE,
    CHR_m, CHR_e, PCT_QUESTION, PCT_EXCLAMATION, CTR_NEWLINE, CTR_ENDLINE};

// {button}{end}{endline}
static s16 scenario_text_0526[] = {CTR_BUTTON, CTR_END, CTR_ENDLINE};

// {begin}{endline}
static s16 scenario_text_0540[] = {CTR_BEGIN, CTR_ENDLINE};

//   {newline}{endline}
static s16 scenario_text_0554[] = {PCT_SPACE, PCT_SPACE, CTR_NEWLINE,
                                   CTR_ENDLINE};

//   Yae receives{newline}{endline}
static s16 scenario_text_056C[] = {
    PCT_SPACE, PCT_SPACE, CHR_Y, CHR_a, CHR_e, PCT_SPACE,
    CHR_r, CHR_e, CHR_c, CHR_e, CHR_i, CHR_v,
...
static s16 scenario_text_0590[256] = {
    ...
    CHR_a, PCT_APOSTROPHE, CHR_s, PCT_SPACE, CHR_f,
    CHR_l, CHR_u, CHR_t, CHR_e, CTR_CLOSE_EM,
    PCT_RBRACKET, PCT_EXCLAMATION, CTR_NEWLINE, CTR_ENDLINE};

// {button}{endline}
static s16 scenario_text_05CF[] = {CTR_BUTTON, CTR_ENDLINE};

// {newwindow}{endline}
static s16 scenario_text_05E4[] = {CTR_NEWWINDOW, CTR_ENDLINE};

//   {newline}{endline}
static s16 scenario_text_05FC[] = {PCT_SPACE, PCT_SPACE, CTR_NEWLINE,
                                   CTR_ENDLINE};

// With this, you can fly to any{newline}{endline}
static s16 scenario_text_0614[] = {
    CHR_W, CHR_i, CHR_t, CHR_h, PCT_SPACE, CHR_t, CHR_h,
    CHR_i, CHR_s, PCT_COMMA, PCT_SPACE, CHR_y, CHR_o, CHR_u,
    PCT_SPACE, CHR_c, CHR_a, CHR_n, PCT_SPACE, CHR_f, CHR_l,
    CHR_y, PCT_SPACE, CHR_t, CHR_o, PCT_SPACE, CHR_a, CHR_n,
    CHR_y, CTR_NEWLINE, CTR_ENDLINE};

// location you've been to before!{button}{endline}
static s16 scenario_text_0647[] = {
    CHR_l, CHR_o, CHR_c, CHR_a, CHR_t, CHR_i,
    CHR_o, CHR_n, PCT_SPACE, CHR_y, CHR_o, CHR_u,
    PCT_APOSTROPHE, CHR_v, CHR_e, PCT_SPACE, CHR_b, CHR_e,
    CHR_e, CHR_n, PCT_SPACE, CHR_t, CHR_o, PCT_SPACE,
    CHR_b, CHR_e, CHR_f, CHR_o, CHR_r, CHR_e,
    PCT_EXCLAMATION, CTR_BUTTON, CTR_ENDLINE};

// {newwindow}{endline}
static s16 scenario_text_067B[] = {CTR_NEWWINDOW, CTR_ENDLINE};

// (This feature can be cancelled by{newline}{endline}
static s16 scenario_text_0693[] = {
    PCT_LPAREN, CHR_T, CHR_h, CHR_i, CHR_s, PCT_SPACE, CHR_f,
    CHR_e, CHR_a, CHR_t, CHR_u, CHR_r, CHR_e, PCT_SPACE,
    CHR_c, CHR_a, CHR_n, PCT_SPACE, CHR_b, CHR_e, PCT_SPACE,
    CHR_c, CHR_a, CHR_n, CHR_c, CHR_e, CHR_l, CHR_l,
    CHR_e, CHR_d, PCT_SPACE, CHR_b, CHR_y, CTR_NEWLINE, CTR_ENDLINE};

//  pressing the [{em-yellow}B{/em} Button] before{newline}{endline}
static s16 scenario_text_06CA[] = {
    PCT_SPACE, CHR_p, CHR_r, CHR_e, CHR_s,
    CHR_s, CHR_i, CHR_n, CHR_g, PCT_SPACE,
    CHR_t, CHR_h, CHR_e, PCT_SPACE, PCT_LBRACKET,
    CTR_EM_YELLOW, CHR_B, CTR_CLOSE_EM, PCT_SPACE, CHR_B,
    CHR_u, CHR_t, CHR_t, CHR_o, CHR_n,
    PCT_RBRACKET, PCT_SPACE, CHR_b, CHR_e, CHR_f,
    CHR_o, CHR_r, CHR_e, CTR_NEWLINE, CTR_ENDLINE};

//  the flute {em-yellow}stops playing{/em}){endline}
static s16 scenario_text_070F[] = {
    PCT_SPACE, CHR_t, CHR_h, CHR_e, PCT_SPACE, CHR_f, CHR_l,
    CHR_u, CHR_t, CHR_e, PCT_SPACE, CTR_EM_YELLOW, CHR_s, CHR_t,
    CHR_o, CHR_p, CHR_s, PCT_SPACE, CHR_p, CHR_l, CHR_a,
    CHR_y, CHR_i, CHR_n, CHR_g, CTR_CLOSE_EM, PCT_RPAREN, CTR_ENDLINE};

// {waitinput}{end}{endline}
static s16 scenario_text_0745[] = {CTR_WAITINPUT, CTR_END, CTR_ENDLINE};

// {begin}{endline}
static s16 scenario_text_0762[] = {CTR_BEGIN, CTR_ENDLINE};

// Koryuta:Oh! I nearly forgot!{newline}{endline}
static s16 scenario_text_0776[] = {
    CHR_K, CHR_o, CHR_r, CHR_y, CHR_u, CHR_t,
    CHR_a, PCT_COLON, CHR_O, CHR_h, PCT_EXCLAMATION, PCT_SPACE,
    CHR_I, PCT_SPACE, CHR_n, CHR_e, CHR_a, CHR_r,
    CHR_l, CHR_y, PCT_SPACE, CHR_f, CHR_o, CHR_r,
    CHR_g, CHR_o, CHR_t, PCT_EXCLAMATION, CTR_NEWLINE, CTR_ENDLINE};

//        Inside a {em-yellow}building{/em}{newline}{endline}
static s16 scenario_text_07A8[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    PCT_SPACE, CHR_I, CHR_n, CHR_s, CHR_i, CHR_d,
    CHR_e, PCT_SPACE, CHR_a, PCT_SPACE, CTR_EM_YELLOW, CHR_b,
    CHR_u, CHR_i, CHR_l, CHR_d, CHR_i, CHR_n,
    CHR_g, CTR_CLOSE_EM, CTR_NEWLINE, CTR_ENDLINE};

//        such as a {em-yellow}castle{/em} or{newline}{endline}
static s16 scenario_text_07E6[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    PCT_SPACE, CHR_s, CHR_u, CHR_c, CHR_h, PCT_SPACE,
    CHR_a, CHR_s, PCT_SPACE, CHR_a, PCT_SPACE, CTR_EM_YELLOW,
    CHR_c, CHR_a, CHR_s, CHR_t, CHR_l, CHR_e,
    CTR_CLOSE_EM, PCT_SPACE, CHR_o, CHR_r, CTR_NEWLINE, CTR_ENDLINE};

//        {em-yellow}store{/em}...{button}{endline}
static s16 scenario_text_0826[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    PCT_SPACE, PCT_SPACE, CTR_EM_YELLOW, CHR_s, CHR_t,
    CHR_o, CHR_r, CHR_e, CTR_CLOSE_EM, PCT_PERIOD,
    PCT_PERIOD, PCT_PERIOD, CTR_BUTTON, CTR_ENDLINE};

// {newwindow}{endline}
static s16 scenario_text_085A[] = {CTR_NEWWINDOW, CTR_ENDLINE};

// Koryuta:...I won't be able to hear{newline}{endline}
static s16 scenario_text_0872[] = {
    CHR_K, CHR_o, CHR_r, CHR_y, CHR_u, CHR_t,
    CHR_a, PCT_COLON, PCT_PERIOD, PCT_PERIOD, PCT_PERIOD, CHR_I,
    PCT_SPACE, CHR_w, CHR_o, CHR_n, PCT_APOSTROPHE, CHR_t,
...
static s16 scenario_text_08AA[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    PCT_SPACE, CHR_t, CHR_h, CHR_e, PCT_SPACE, CHR_f,
    CHR_l, CHR_u, CHR_t, CHR_e, PCT_COMMA, PCT_SPACE,
    CHR_s, CHR_o, PCT_SPACE, CHR_m, CHR_a, CHR_k,
    CHR_e, PCT_SPACE, CHR_s, CHR_u, CHR_r, CHR_e,
    CTR_NEWLINE, CTR_ENDLINE};

//        you're {em-yellow}outside{/em} when you{newline}{endline}
static s16 scenario_text_08DE[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    PCT_SPACE, CHR_y, CHR_o, CHR_u, PCT_APOSTROPHE, CHR_r,
    CHR_e, PCT_SPACE, CTR_EM_YELLOW, CHR_o, CHR_u, CHR_t,
    CHR_s, CHR_i, CHR_d, CHR_e, CTR_CLOSE_EM, PCT_SPACE,
...
static s16 scenario_text_0922[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    PCT_SPACE, CHR_p, CHR_l, CHR_a, CHR_y, PCT_SPACE,
    CHR_i, CHR_t, PCT_EXCLAMATION, CTR_BUTTON, CTR_ENDLINE};

// {newwindow}{endline}
static s16 scenario_text_0946[] = {CTR_NEWWINDOW, CTR_ENDLINE};

// Koryuta:Oh yes,{newline}{endline}
static s16 scenario_text_095E[] = {
    CHR_K, CHR_o, CHR_r, CHR_y, CHR_u, CHR_t,
    CHR_a, PCT_COLON, CHR_O, CHR_h, PCT_SPACE, CHR_y,
    CHR_e, CHR_s, PCT_COMMA, CTR_NEWLINE, CTR_ENDLINE};

//        and take this {em-yellow}map{/em}!{newline}{endline}
static s16 scenario_text_0983[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    PCT_SPACE, PCT_SPACE, CHR_a, CHR_n, CHR_d,
    PCT_SPACE, CHR_t, CHR_a, CHR_k, CHR_e,
    PCT_SPACE, CHR_t, CHR_h, CHR_i, CHR_s,
    PCT_SPACE, CTR_EM_YELLOW, CHR_m, CHR_a, CHR_p,
    CTR_CLOSE_EM, PCT_EXCLAMATION, CTR_NEWLINE, CTR_ENDLINE};

//        I'm sure it will come in{newline}{endline}
static s16 scenario_text_09C2[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    PCT_SPACE, CHR_I, PCT_APOSTROPHE, CHR_m, PCT_SPACE, CHR_s,
    CHR_u, CHR_r, CHR_e, PCT_SPACE, CHR_i, CHR_t,
    PCT_SPACE, CHR_w, CHR_i, CHR_l, CHR_l, PCT_SPACE,
    CHR_c, CHR_o, CHR_m, CHR_e, PCT_SPACE, CHR_i,
    CHR_n, CTR_NEWLINE, CTR_ENDLINE};

//        handy!{button}{end}{endline}
static s16 scenario_text_09F7[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    PCT_SPACE, CHR_h, CHR_a, CHR_n, CHR_d, CHR_y,
    PCT_EXCLAMATION, CTR_BUTTON, CTR_END, CTR_ENDLINE};

// {begin}{endline}
static s16 scenario_text_0A1E[] = {CTR_BEGIN, CTR_ENDLINE};

//   {newline}{endline}
static s16 scenario_text_0A32[] = {PCT_SPACE, PCT_SPACE, CTR_NEWLINE,
                                   CTR_ENDLINE};
...
static s16 scenario_text_0A71[] = {
    CHR_a, CHR_l, CHR_s, CHR_o, PCT_SPACE,
    CHR_r, CHR_e, CHR_c, CHR_e, CHR_i,
    CHR_v, CHR_e, PCT_SPACE, CHR_t, CHR_h,
    CHR_e, PCT_SPACE, PCT_LBRACKET, CTR_EM_YELLOW, CHR_M,
    CHR_a, CHR_p, PCT_SPACE, CHR_o, CHR_f,
    PCT_SPACE, CHR_J, CHR_a, CHR_p, CHR_a,
    CHR_n, CTR_CLOSE_EM, PCT_RBRACKET, PCT_EXCLAMATION, CTR_BUTTON,
    CTR_ENDLINE};

// {newwindow}{endline}
static s16 scenario_text_0AB6[] = {CTR_NEWWINDOW, CTR_ENDLINE};

// Step out of any building and{newline}{endline}
static s16 scenario_text_0ACE[] = {
    CHR_S, CHR_t, CHR_e, CHR_p, PCT_SPACE, CHR_o,
    CHR_u, CHR_t, PCT_SPACE, CHR_o, CHR_f, PCT_SPACE,
    CHR_a, CHR_n, CHR_y, PCT_SPACE, CHR_b, CHR_u,
    CHR_i, CHR_l, CHR_d, CHR_i, CHR_n, CHR_g,
...
static s16 scenario_text_0B00[] = {
    CHR_p, CHR_r, CHR_e, CHR_s, CHR_s, PCT_SPACE, CHR_t,
    CHR_h, CHR_e, PCT_SPACE, CTR_EM_RED, CHR_S, CHR_T, CHR_A,
    CHR_R, CHR_T, CTR_CLOSE_EM, PCT_SPACE, CHR_B, CHR_u, CHR_t,
    CHR_t, CHR_o, CHR_n, PCT_COMMA, CTR_NEWLINE, CTR_ENDLINE};

// then by pressing the {em-yellow}Z{/em} Button,{newline}{endline}
static s16 scenario_text_0B3A[] = {
    CHR_t, CHR_h, CHR_e, CHR_n, PCT_SPACE, CHR_b,
    CHR_y, PCT_SPACE, CHR_p, CHR_r, CHR_e, CHR_s,
    CHR_s, CHR_i, CHR_n, CHR_g, PCT_SPACE, CHR_t,
    CHR_h, CHR_e, PCT_SPACE, CTR_EM_YELLOW, CHR_Z, CTR_CLOSE_EM,
...
static s16 scenario_text_0B7E[] = {
    ...
    CHR_n, PCT_SPACE, CHR_s, CHR_w, CHR_i, CHR_t,
    CHR_c, CHR_h, PCT_SPACE, CHR_b, CHR_a, CHR_c,
    CHR_k, PCT_SPACE, CHR_a, CHR_n, CHR_d, PCT_SPACE,
    CHR_f, CHR_o, CHR_r, CHR_t, CHR_h, PCT_PERIOD,
    CTR_WAITINPUT, CTR_END, CTR_ENDLINE};

// {begin}{endline}
static s16 scenario_text_0BB9[] = {CTR_BEGIN, CTR_ENDLINE};
...
static s16 scenario_text_0BCD[] = {
    CHR_K, CHR_o, CHR_r, CHR_y, CHR_u, CHR_t, CHR_a,
    PCT_COLON, CHR_W, CHR_e, CHR_l, CHR_l, PCT_COMMA, PCT_SPACE,
    CHR_I, PCT_SPACE, CHR_m, CHR_u, CHR_s, CHR_t, PCT_SPACE,
    CHR_b, CHR_e, PCT_SPACE, CHR_g, CHR_o, CHR_i, CHR_n,
    CHR_g, PCT_EXCLAMATION, CTR_ENDLINE};
...
s32 scenario_code_message_1ef_72b4[] = {
    ...
    // 735c: Print Text
    TXT,
    (s32)&scenario_text_006C,

    // 7364: Print Text
    TXT,
    (s32)&scenario_text_0096,

    // 736c: Print Text
    TXT,
    (s32)&scenario_text_00BF,
    ...
    // 737c: Print Text
    TXT,
    (s32)&scenario_text_0117,

    // 7384: Print Text
    TXT,
    (s32)&scenario_text_0148,

    // 738c: Print Text
    TXT,
    (s32)&scenario_text_018B,
    ...
    // 739c: Print Text
    TXT,
    (s32)&scenario_text_01C4,

    // 73a4: Print Text
    TXT,
    (s32)&scenario_text_01F8,
    ...
    // 73fc: Print Text
    TXT,
    (s32)&scenario_text_0313,

    // 7404: Print Text
    TXT,
    (s32)&scenario_text_0346,
    ...
    // 746c: Print Text
    TXT,
    (s32)&scenario_text_0444,

    // 7474: Print Text
    TXT,
    (s32)&scenario_text_0480,

    // 747c: Print Text
    TXT,
    (s32)&scenario_text_04B0,
