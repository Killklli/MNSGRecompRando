// Adjusts scenario_code_message_162_d63c so you always learn Kihachi's favorite food
#include "scenario.h"
#include "modding.h"
...
static s16 scenario_text_0014[] = {
    CHR_W, CHR_h, CHR_a, CHR_t, PCT_APOSTROPHE, CHR_d, PCT_SPACE, CHR_y, CHR_o, CHR_u,
    PCT_SPACE, CHR_s, CHR_a, CHR_y, PCT_QUESTION, CTR_BUTTON, CTR_ENDLINE
};
...
static s16 scenario_text_0050[] = {
    ...
    CHR_u, PCT_SPACE, CHR_w, CHR_a, CHR_n, CHR_t, PCT_SPACE, CHR_w, CHR_i, CHR_t,
    CHR_h, PCT_SPACE, CHR_m, CHR_e, PCT_COMMA, CTR_NEWLINE, CTR_ENDLINE
};

// the mighty water imp {em-yellow}Kihachi{/em}?{button}{end}{endline}
static s16 scenario_text_007F[] = {
    CHR_t, CHR_h, CHR_e, PCT_SPACE, CHR_m, CHR_i, CHR_g, CHR_h, CHR_t, CHR_y,
    PCT_SPACE, CHR_w, CHR_a, CHR_t, CHR_e, CHR_r, PCT_SPACE, CHR_i, CHR_m, CHR_p,
    PCT_SPACE, CTR_EM_YELLOW, CHR_K, CHR_i, CHR_h, CHR_a, CHR_c, CHR_h, CHR_i, CTR_CLOSE_EM,
    PCT_QUESTION, CTR_BUTTON, CTR_END, CTR_ENDLINE
};

// {waitinput}{end}{endline}
static s16 scenario_text_00C6[] = {
...
static s16 scenario_text_00F7[] = {
    CHR_G, CHR_o, CHR_e, CHR_m, CHR_o, CHR_n, PCT_COLON, CHR_I, PCT_APOSTROPHE, CHR_v,
    CHR_e, PCT_SPACE, CHR_g, CHR_o, CHR_t, PCT_SPACE, CHR_a, PCT_SPACE, CHR_q, CHR_u,
    CHR_e, CHR_s, CHR_t, CHR_i, CHR_o, CHR_n, PCT_PERIOD, PCT_PERIOD, PCT_PERIOD, CTR_BUTTON,
    CTR_ENDLINE
};
...
static s16 scenario_text_0141[] = {
    CHR_G, CHR_o, CHR_e, CHR_m, CHR_o, CHR_n, PCT_COLON, CHR_D, CHR_i, CHR_d,
    PCT_SPACE, CHR_y, CHR_o, CHR_u, PCT_SPACE, CHR_p, CHR_i, CHR_c, CHR_k, PCT_SPACE,
    CHR_u, CHR_p, CTR_NEWLINE, CTR_ENDLINE
};

//       a strange {em-yellow}item{/em} around{newline}{endline}
static s16 scenario_text_016D[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_a, PCT_SPACE, CHR_s, CHR_t,
    CHR_r, CHR_a, CHR_n, CHR_g, CHR_e, PCT_SPACE, CTR_EM_YELLOW, CHR_i, CHR_t, CHR_e,
    CHR_m, CTR_CLOSE_EM, PCT_SPACE, CHR_a, CHR_r, CHR_o, CHR_u, CHR_n, CHR_d, CTR_NEWLINE,
    CTR_ENDLINE
};

//       here?{button}{end}{endline}
static s16 scenario_text_01AE[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_h, CHR_e, CHR_r, CHR_e,
    PCT_QUESTION, CTR_BUTTON, CTR_END, CTR_ENDLINE
};
...
static s16 scenario_text_01E7[] = {
    ...
    CHR_a, CHR_s, CHR_k, PCT_SPACE, CHR_y, CHR_o, CHR_u, CTR_NEWLINE, CTR_ENDLINE
};
...
static s16 scenario_text_0218[] = {
    ...
    CHR_e, CHR_t, CHR_h, CHR_i, CHR_n, CHR_g, PCT_PERIOD, PCT_PERIOD, PCT_PERIOD, CTR_BUTTON,
    CTR_ENDLINE
};

// {newwindow}{endline}
static s16 scenario_text_0240[] = {
    CTR_NEWWINDOW, CTR_ENDLINE
};
...
static s16 scenario_text_0258[] = {
    CHR_E, CHR_b, CHR_i, CHR_s, CHR_u, CHR_m, CHR_a, CHR_r, CHR_u, PCT_COLON,
    CHR_D, CHR_o, PCT_SPACE, CHR_y, CHR_o, CHR_u, PCT_SPACE, CHR_h, CHR_a, CHR_v,
    CHR_e, PCT_SPACE, CHR_a, PCT_SPACE, CHR_s, CHR_t, CHR_r, CHR_a, CHR_n, CHR_g,
    CHR_e, CTR_NEWLINE, CTR_ENDLINE
};

//        {em-yellow}item{/em} that you might have{newline}{endline}
static s16 scenario_text_028D[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CTR_EM_YELLOW, CHR_i, CHR_t,
    CHR_e, CHR_m, CTR_CLOSE_EM, PCT_SPACE, CHR_t, CHR_h, CHR_a, CHR_t, PCT_SPACE, CHR_y,
    CHR_o, CHR_u, PCT_SPACE, CHR_m, CHR_i, CHR_g, CHR_h, CHR_t, PCT_SPACE, CHR_h,
    CHR_a, CHR_v, CHR_e, CTR_NEWLINE, CTR_ENDLINE
};

//        picked up around here?{button}{end}{endline}
static s16 scenario_text_02D2[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_p, CHR_i, CHR_c,
    CHR_k, CHR_e, CHR_d, PCT_SPACE, CHR_u, CHR_p, PCT_SPACE, CHR_a, CHR_r, CHR_o,
    CHR_u, CHR_n, CHR_d, PCT_SPACE, CHR_h, CHR_e, CHR_r, CHR_e, PCT_QUESTION, CTR_BUTTON,
    CTR_END, CTR_ENDLINE
};
...
// {begin}{endline}
static s16 scenario_text_0309[] = {
    CTR_BEGIN, CTR_ENDLINE
};

// Yae:I'm sorry to bother you...{button}{endline}
static s16 scenario_text_031D[] = {
    CHR_Y, CHR_a, CHR_e, PCT_COLON, CHR_I, PCT_APOSTROPHE, CHR_m, PCT_SPACE, CHR_s, CHR_o,
    CHR_r, CHR_r, CHR_y, PCT_SPACE, CHR_t, CHR_o, PCT_SPACE, CHR_b, CHR_o, CHR_t,
    CHR_h, CHR_e, CHR_r, PCT_SPACE, CHR_y, CHR_o, CHR_u, PCT_PERIOD, PCT_PERIOD, PCT_PERIOD,
...
static s16 scenario_text_0368[] = {
    CHR_Y, CHR_a, CHR_e, PCT_COLON, CHR_B, CHR_u, CHR_t, PCT_SPACE, CHR_d, CHR_o,
    PCT_SPACE, CHR_y, CHR_o, CHR_u, PCT_SPACE, CHR_r, CHR_e, CHR_m, CHR_e, CHR_m,
    CHR_b, CHR_e, CHR_r, CTR_NEWLINE, CTR_ENDLINE
};

//       picking up an unusual {em-yellow}item{/em}{newline}{endline}
static s16 scenario_text_0395[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_p, CHR_i, CHR_c, CHR_k,
    CHR_i, CHR_n, CHR_g, PCT_SPACE, CHR_u, CHR_p, PCT_SPACE, CHR_a, CHR_n, PCT_SPACE,
    CHR_u, CHR_n, CHR_u, CHR_s, CHR_u, CHR_a, CHR_l, PCT_SPACE, CTR_EM_YELLOW, CHR_i,
    CHR_t, CHR_e, CHR_m, CTR_CLOSE_EM, CTR_NEWLINE, CTR_ENDLINE
};

//       around here?{button}{end}{endline}
static s16 scenario_text_03DB[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_a, CHR_r, CHR_o, CHR_u,
    CHR_n, CHR_d, PCT_SPACE, CHR_h, CHR_e, CHR_r, CHR_e, PCT_QUESTION, CTR_BUTTON, CTR_END,
    CTR_ENDLINE
};
...
// {begin}{endline}
static s16 scenario_text_0407[] = {
    CTR_BEGIN, CTR_ENDLINE
};

// Sasuke:Mr.Kihachi,{newline}{endline}
static s16 scenario_text_041B[] = {
    CHR_S, CHR_a, CHR_s, CHR_u, CHR_k, CHR_e, PCT_COLON, CHR_M, CHR_r, PCT_PERIOD,
    CHR_K, CHR_i, CHR_h, CHR_a, CHR_c, CHR_h, CHR_i, PCT_COMMA, CTR_NEWLINE, CTR_ENDLINE
};

//       I was wondering...{button}{endline}
static s16 scenario_text_0443[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_I, PCT_SPACE, CHR_w, CHR_a,
    CHR_s, PCT_SPACE, CHR_w, CHR_o, CHR_n, CHR_d, CHR_e, CHR_r, CHR_i, CHR_n,
    CHR_g, PCT_PERIOD, PCT_PERIOD, PCT_PERIOD, CTR_BUTTON, CTR_ENDLINE
};
...
static s16 scenario_text_0488[] = {
    ...
    CHR_t, PCT_SPACE, CHR_m, CHR_a, CHR_y, CHR_b, CHR_e, PCT_SPACE, CHR_y, CHR_o,
    CHR_u, PCT_SPACE, CHR_m, CHR_i, CHR_g, CHR_h, CHR_t, PCT_SPACE, CHR_h, CHR_a,
...
static s16 scenario_text_04BE[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_p, CHR_i, CHR_c, CHR_k,
    CHR_e, CHR_d, PCT_SPACE, CHR_u, CHR_p, PCT_SPACE, CHR_a, PCT_SPACE, CHR_p, CHR_e,
    CHR_c, CHR_u, CHR_l, CHR_i, CHR_a, CHR_r, PCT_SPACE, CTR_EM_YELLOW, CHR_i, CHR_t,
    CHR_e, CHR_m, CTR_CLOSE_EM, CTR_NEWLINE, CTR_ENDLINE
};

//       in this town recently.{button}{end}{endline}
static s16 scenario_text_0503[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_i, CHR_n, PCT_SPACE, CHR_t,
    CHR_h, CHR_i, CHR_s, PCT_SPACE, CHR_t, CHR_o, CHR_w, CHR_n, PCT_SPACE, CHR_r,
    CHR_e, CHR_c, CHR_e, CHR_n, CHR_t, CHR_l, CHR_y, PCT_PERIOD, CTR_BUTTON, CTR_END,
    CTR_ENDLINE
};
...
// {begin}{endline}
static s16 scenario_text_0539[] = {
    CTR_BEGIN, CTR_ENDLINE
};

// Kihachi:Hmmm... {newline}{endline}
static s16 scenario_text_054D[] = {
    CHR_K, CHR_i, CHR_h, CHR_a, CHR_c, CHR_h, CHR_i, PCT_COLON, CHR_H, CHR_m,
    CHR_m, CHR_m, PCT_PERIOD, PCT_PERIOD, PCT_PERIOD, PCT_SPACE, CTR_NEWLINE, CTR_ENDLINE
};

//       Maybe you're referring to{newline}{endline}
static s16 scenario_text_0573[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_M, CHR_a, CHR_y, CHR_b,
    CHR_e, PCT_SPACE, CHR_y, CHR_o, CHR_u, PCT_APOSTROPHE, CHR_r, CHR_e, PCT_SPACE, CHR_r,
    CHR_e, CHR_f, CHR_e, CHR_r, CHR_r, CHR_i, CHR_n, CHR_g, PCT_SPACE, CHR_t,
...
static s16 scenario_text_05A8[] = {
    ...
    PCT_SPACE, CTR_EM_YELLOW, CHR_o, CHR_d, CHR_d, PCT_SPACE, CHR_i, CHR_t, CHR_e, CHR_m,
    CTR_CLOSE_EM, PCT_SPACE, CHR_I, PCT_SPACE, CHR_p, CHR_i, CHR_c, CHR_k, CHR_e, CHR_d,
...
static s16 scenario_text_05ED[] = {
    ...
    CHR_o, CHR_t, CHR_h, CHR_e, CHR_r, PCT_SPACE, CHR_d, CHR_a, CHR_y, PCT_QUESTION,
    CTR_BUTTON, CTR_END, CTR_ENDLINE
};

// {begin}{endline}
static s16 scenario_text_061B[] = {
    CTR_BEGIN, CTR_ENDLINE
};

// Goemon:Is that a fact?{newline}{endline}
static s16 scenario_text_062F[] = {
    CHR_G, CHR_o, CHR_e, CHR_m, CHR_o, CHR_n, PCT_COLON, CHR_I, CHR_s, PCT_SPACE,
    CHR_t, CHR_h, CHR_a, CHR_t, PCT_SPACE, CHR_a, PCT_SPACE, CHR_f, CHR_a, CHR_c,
...
static s16 scenario_text_065B[] = {
    ...
    CHR_h, CHR_a, CHR_t, PCT_APOSTROPHE, CHR_s, PCT_SPACE, CHR_t, CHR_r, CHR_u, CHR_e,
    PCT_COMMA, CTR_NEWLINE, CTR_ENDLINE
};

//       can you give it to us?{button}{end}{endline}
static s16 scenario_text_0686[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_c, CHR_a, CHR_n, PCT_SPACE,
    CHR_y, CHR_o, CHR_u, PCT_SPACE, CHR_g, CHR_i, CHR_v, CHR_e, PCT_SPACE, CHR_i,
    CHR_t, PCT_SPACE, CHR_t, CHR_o, PCT_SPACE, CHR_u, CHR_s, PCT_QUESTION, CTR_BUTTON, CTR_END,
    CTR_ENDLINE
};

// {begin}{endline}
static s16 scenario_text_06BC[] = {
    CTR_BEGIN, CTR_ENDLINE
};

// Kihachi:Get real!{newline}{endline}
static s16 scenario_text_06D0[] = {
    CHR_K, CHR_i, CHR_h, CHR_a, CHR_c, CHR_h, CHR_i, PCT_COLON, CHR_G, CHR_e,
    CHR_t, PCT_SPACE, CHR_r, CHR_e, CHR_a, CHR_l, PCT_EXCLAMATION, CTR_NEWLINE, CTR_ENDLINE
};
...
static s16 scenario_text_06F7[] = {
    ...
    CHR_d, CHR_o, CHR_n, PCT_APOSTROPHE, CHR_t, PCT_SPACE, CHR_j, CHR_u, CHR_s, CHR_t,
    PCT_SPACE, CHR_a, CHR_s, CHR_k, PCT_SPACE, CHR_t, CHR_o, PCT_SPACE, CTR_NEWLINE, CTR_ENDLINE
};

//       get something for nothing!{button}{endline}
static s16 scenario_text_0729[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_g, CHR_e, CHR_t, PCT_SPACE,
    CHR_s, CHR_o, CHR_m, CHR_e, CHR_t, CHR_h, CHR_i, CHR_n, CHR_g, PCT_SPACE,
    CHR_f, CHR_o, CHR_r, PCT_SPACE, CHR_n, CHR_o, CHR_t, CHR_h, CHR_i, CHR_n,
...
static s16 scenario_text_0776[] = {
    CHR_K, CHR_i, CHR_h, CHR_a, CHR_c, CHR_h, CHR_i, PCT_COLON, CHR_T, CHR_r,
    CHR_y, PCT_SPACE, CHR_c, CHR_a, CHR_r, CHR_v, CHR_i, CHR_n, CHR_g, PCT_SPACE,
    CHR_t, CHR_h, CHR_e, PCT_SPACE, CHR_w, CHR_o, CHR_r, CHR_d, CTR_NEWLINE, CTR_ENDLINE
};

//       "{em-yellow}WORLD{/em}" in that piece{newline}{endline}
static s16 scenario_text_07A8[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_QUOTE, CTR_EM_YELLOW, CHR_W, CHR_O,
    CHR_R, CHR_L, CHR_D, CTR_CLOSE_EM, PCT_QUOTE, PCT_SPACE, CHR_i, CHR_n, PCT_SPACE, CHR_t,
    CHR_h, CHR_a, CHR_t, PCT_SPACE, CHR_p, CHR_i, CHR_e, CHR_c, CHR_e, CTR_NEWLINE,
    CTR_ENDLINE
};

//       of rock...{button}{endline}
static s16 scenario_text_07E9[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_o, CHR_f, PCT_SPACE, CHR_r,
    CHR_o, CHR_c, CHR_k, PCT_PERIOD, PCT_PERIOD, PCT_PERIOD, CTR_BUTTON, CTR_ENDLINE
};

// {newwindow}{endline}
static s16 scenario_text_080E[] = {
    CTR_NEWWINDOW, CTR_ENDLINE
};

// Kihachi:And tell me out loud{newline}{endline}
static s16 scenario_text_0826[] = {
    CHR_K, CHR_i, CHR_h, CHR_a, CHR_c, CHR_h, CHR_i, PCT_COLON, CHR_A, CHR_n,
    CHR_d, PCT_SPACE, CHR_t, CHR_e, CHR_l, CHR_l, PCT_SPACE, CHR_m, CHR_e, PCT_SPACE,
    CHR_o, CHR_u, CHR_t, PCT_SPACE, CHR_l, CHR_o, CHR_u, CHR_d, CTR_NEWLINE, CTR_ENDLINE
};
...
static s16 scenario_text_0858[] = {
    ...
    PCT_SPACE, CHR_y, CHR_o, CHR_u, PCT_SPACE, CHR_h, CHR_a, CHR_v, CHR_e, PCT_PERIOD,
...
static s16 scenario_text_089C[] = {
    CHR_E, CHR_b, CHR_i, CHR_s, CHR_u, CHR_m, CHR_a, CHR_r, CHR_u, PCT_COLON,
    CHR_H, CHR_e, CHR_y, PCT_COMMA, PCT_SPACE, CHR_t, CHR_h, CHR_a, CHR_t, PCT_APOSTROPHE,
    CHR_s, PCT_SPACE, CHR_p, CHR_r, CHR_e, CHR_t, CHR_t, CHR_y, CTR_NEWLINE, CTR_ENDLINE
};

//        tough, it's no easy task{newline}{endline}
static s16 scenario_text_08CE[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_t, CHR_o, CHR_u,
    CHR_g, CHR_h, PCT_COMMA, PCT_SPACE, CHR_i, CHR_t, PCT_APOSTROPHE, CHR_s, PCT_SPACE, CHR_n,
    CHR_o, PCT_SPACE, CHR_e, CHR_a, CHR_s, CHR_y, PCT_SPACE, CHR_t, CHR_a, CHR_s,
...
static s16 scenario_text_0903[] = {
    ...
    CHR_c, CHR_a, CHR_r, CHR_v, CHR_e, PCT_SPACE, PCT_QUOTE, CTR_EM_YELLOW, CHR_W, CHR_O,
    CHR_R, CHR_L, CHR_D, CTR_CLOSE_EM, PCT_QUOTE, PCT_SPACE, CHR_o, CHR_n, CTR_NEWLINE, CTR_ENDLINE
};

//        here!{button}{endline}
static s16 scenario_text_0943[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_h, CHR_e, CHR_r,
    CHR_e, PCT_EXCLAMATION, CTR_BUTTON, CTR_ENDLINE
};

// {newwindow}{endline}
static s16 scenario_text_0964[] = {
    CTR_NEWWINDOW, CTR_ENDLINE
};

// Goemon:It's a tough world!{button}{end}{endline}
static s16 scenario_text_097C[] = {
    CHR_G, CHR_o, CHR_e, CHR_m, CHR_o, CHR_n, PCT_COLON, CHR_I, CHR_t, PCT_APOSTROPHE,
    CHR_s, PCT_SPACE, CHR_a, PCT_SPACE, CHR_t, CHR_o, CHR_u, CHR_g, CHR_h, PCT_SPACE,
    CHR_w, CHR_o, CHR_r, CHR_l, CHR_d, PCT_EXCLAMATION, CTR_BUTTON, CTR_END, CTR_ENDLINE
};

// {begin}{endline}
static s16 scenario_text_09B0[] = {
    CTR_BEGIN, CTR_ENDLINE
};

// Kihachi:In any case,{newline}{endline}
static s16 scenario_text_09C4[] = {
    CHR_K, CHR_i, CHR_h, CHR_a, CHR_c, CHR_h, CHR_i, PCT_COLON, CHR_I, CHR_n,
    PCT_SPACE, CHR_a, CHR_n, CHR_y, PCT_SPACE, CHR_c, CHR_a, CHR_s, CHR_e, PCT_COMMA,
...
static s16 scenario_text_09EE[] = {
    ...
    CHR_n, PCT_APOSTROPHE, CHR_t, PCT_SPACE, CHR_j, CHR_u, CHR_s, CHR_t, PCT_SPACE, CHR_g,
    CHR_o, PCT_SPACE, CHR_a, CHR_r, CHR_o, CHR_u, CHR_n, CHR_d, CTR_NEWLINE, CTR_ENDLINE
};

//       giving away parts of my{newline}{endline}
static s16 scenario_text_0A20[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_g, CHR_i, CHR_v, CHR_i,
    CHR_n, CHR_g, PCT_SPACE, CHR_a, CHR_w, CHR_a, CHR_y, PCT_SPACE, CHR_p, CHR_a,
    CHR_r, CHR_t, CHR_s, PCT_SPACE, CHR_o, CHR_f, PCT_SPACE, CHR_m, CHR_y, CTR_NEWLINE,
    CTR_ENDLINE
};

//       valuable {em-yellow}collection{/em}.{button}{end}{endline}
static s16 scenario_text_0A53[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_v, CHR_a, CHR_l, CHR_u,
    CHR_a, CHR_b, CHR_l, CHR_e, PCT_SPACE, CTR_EM_YELLOW, CHR_c, CHR_o, CHR_l, CHR_l,
    CHR_e, CHR_c, CHR_t, CHR_i, CHR_o, CHR_n, CTR_CLOSE_EM, PCT_PERIOD, CTR_BUTTON, CTR_END,
    CTR_ENDLINE
};

// {begin}{endline}
static s16 scenario_text_0A97[] = {
    CTR_BEGIN, CTR_ENDLINE
};

// Yae:Please reconsider.{newline}{endline}
static s16 scenario_text_0AAB[] = {
    CHR_Y, CHR_a, CHR_e, PCT_COLON, CHR_P, CHR_l, CHR_e, CHR_a, CHR_s, CHR_e,
    PCT_SPACE, CHR_r, CHR_e, CHR_c, CHR_o, CHR_n, CHR_s, CHR_i, CHR_d, CHR_e,
...
static s16 scenario_text_0AD7[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_W, CHR_e, PCT_SPACE, CHR_r,
    CHR_e, CHR_a, CHR_l, CHR_l, CHR_y, PCT_SPACE, CHR_n, CHR_e, CHR_e, CHR_d,
    PCT_SPACE, CTR_EM_YELLOW, CHR_t, CHR_h, CHR_a, CHR_t, PCT_SPACE, CHR_i, CHR_t, CHR_e,
    CHR_m, CTR_CLOSE_EM, PCT_PERIOD, CTR_BUTTON, CTR_END, CTR_ENDLINE
};

// {begin}{endline}
static s16 scenario_text_0B20[] = {
    CTR_BEGIN, CTR_ENDLINE
};
...
static s16 scenario_text_0B34[] = {
    CHR_K, CHR_i, CHR_h, CHR_a, CHR_c, CHR_h, CHR_i, PCT_COLON, CHR_H, CHR_m,
    CHR_m, CHR_m, CHR_m, CHR_m, CHR_m, PCT_PERIOD, PCT_PERIOD, PCT_PERIOD, CTR_BUTTON, CTR_ENDLINE
};

// {newwindow}{endline}
static s16 scenario_text_0B5B[] = {
    CTR_NEWWINDOW, CTR_ENDLINE
};

// Kihachi:It's so hard to say no{newline}{endline}
static s16 scenario_text_0B73[] = {
    CHR_K, CHR_i, CHR_h, CHR_a, CHR_c, CHR_h, CHR_i, PCT_COLON, CHR_I, CHR_t,
    PCT_APOSTROPHE, CHR_s, PCT_SPACE, CHR_s, CHR_o, PCT_SPACE, CHR_h, CHR_a, CHR_r, CHR_d,
    PCT_SPACE, CHR_t, CHR_o, PCT_SPACE, CHR_s, CHR_a, CHR_y, PCT_SPACE, CHR_n, CHR_o,
    CTR_NEWLINE, CTR_ENDLINE
};

//       to someone so {em-yellow}cute{/em}{newline}{endline}
static s16 scenario_text_0BA7[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_t, CHR_o, PCT_SPACE, CHR_s,
    CHR_o, CHR_m, CHR_e, CHR_o, CHR_n, CHR_e, PCT_SPACE, CHR_s, CHR_o, PCT_SPACE,
    CTR_EM_YELLOW, CHR_c, CHR_u, CHR_t, CHR_e, CTR_CLOSE_EM, CTR_NEWLINE, CTR_ENDLINE
};

//       as you.{newline}{endline}
static s16 scenario_text_0BE5[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_a, CHR_s, PCT_SPACE, CHR_y,
...
// {begin}{endline}
static s16 scenario_text_0C22[] = {
    CTR_BEGIN, CTR_ENDLINE
};

// Kihachi:{em-yellow}Cucumber{/em}...{endline}
static s16 scenario_text_0C36[] = {
    CHR_K, CHR_i, CHR_h, CHR_a, CHR_c, CHR_h, CHR_i, PCT_COLON, CTR_EM_YELLOW, CHR_C,
    CHR_u, CHR_c, CHR_u, CHR_m, CHR_b, CHR_e, CHR_r, CTR_CLOSE_EM, PCT_PERIOD, PCT_PERIOD,
    PCT_PERIOD, CTR_ENDLINE
};

// {waitinput}{end}{endline}
static s16 scenario_text_0C66[] = {
    CTR_WAITINPUT, CTR_END, CTR_ENDLINE
};
...
static s16 scenario_text_0C83[] = {
    CHR_K, CHR_i, CHR_h, CHR_a, CHR_c, CHR_h, CHR_i, PCT_COLON, CTR_EM_YELLOW, CHR_C,
    CHR_u, CHR_c, CHR_u, CHR_m, CHR_b, CHR_e, CHR_r, CTR_CLOSE_EM, PCT_SPACE, CHR_t,
...
static s16 scenario_text_0CBE[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_t, CHR_h, CHR_e, PCT_SPACE,
    CTR_EM_YELLOW, CHR_p, CHR_r, CHR_i, CHR_e, CHR_s, CHR_t, PCT_APOSTROPHE, CHR_s, PCT_SPACE,
    CHR_s, CHR_o, CHR_n, CTR_CLOSE_EM, PCT_SPACE, CHR_m, CHR_a, CHR_k, CHR_e, CHR_s,
    PCT_PERIOD, PCT_PERIOD, PCT_PERIOD, CTR_ENDLINE
};

// {waitinput}{end}{endline}
static s16 scenario_text_0CFA[] = {
    CTR_WAITINPUT, CTR_END, CTR_ENDLINE
};
...
static s16 scenario_text_0D17[] = {
    ...
    CHR_s, PCT_EXCLAMATION, PCT_SPACE, CHR_T, CHR_h, CHR_a, CHR_t, PCT_APOSTROPHE, CHR_s, PCT_SPACE,
    CHR_i, CHR_t, PCT_EXCLAMATION, CTR_BUTTON, CTR_END, CTR_ENDLINE
};

// {begin}{endline}
static s16 scenario_text_0D48[] = {
    CTR_BEGIN, CTR_ENDLINE
};
...
static s16 scenario_text_0D5C[] = {
    ...
    CHR_a, CHR_d, CHR_e, PCT_SPACE, CHR_t, CHR_h, CHR_e, CHR_i, CHR_r, CTR_NEWLINE,
    CTR_ENDLINE
};
...
// {begin}{endline}
static s16 scenario_text_0E0D[] = {
    CTR_BEGIN, CTR_ENDLINE
};

// {newwindow}{endline}
static s16 scenario_text_0E21[] = {
    CTR_NEWWINDOW, CTR_ENDLINE
};
...
static s16 scenario_text_0EA5[] = {
    ...
    CHR_n, CHR_o, CHR_w, PCT_SPACE, CHR_f, CHR_l, CHR_a, CHR_k, CHR_e, PCT_PERIOD,
    CTR_ENDLINE
};

// {end}{endline}
static s16 scenario_text_0ED0[] = {
    CTR_END, CTR_ENDLINE
};
...
static s16 scenario_text_0F46[] = {
    CHR_K, CHR_i, CHR_h, CHR_a, CHR_c, CHR_h, CHR_i, PCT_COLON, CHR_E, CHR_a,
    CHR_t, CHR_i, CHR_n, CHR_g, PCT_SPACE, CHR_c, CHR_u, CHR_c, CHR_u, CHR_m,
    CHR_b, CHR_e, CHR_r, CTR_NEWLINE, CTR_ENDLINE
};

//       while watching{newline}{endline}
static s16 scenario_text_0F73[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_w, CHR_h, CHR_i, CHR_l,
    CHR_e, PCT_SPACE, CHR_w, CHR_a, CHR_t, CHR_c, CHR_h, CHR_i, CHR_n, CHR_g,
    CTR_NEWLINE, CTR_ENDLINE
};
...
static s16 scenario_text_0F9D[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_t, CHR_h, CHR_e, PCT_SPACE,
    CHR_B, CHR_i, CHR_g, PCT_SPACE, CHR_S, CHR_a, CHR_c, CHR_r, CHR_e, CHR_d,
    PCT_SPACE, CHR_F, CHR_i, CHR_r, CHR_e, PCT_PERIOD, PCT_PERIOD, PCT_PERIOD, CTR_BUTTON, CTR_ENDLINE
};

// {newwindow}{endline}
static s16 scenario_text_0FCE[] = {
    CTR_NEWWINDOW, CTR_ENDLINE
};

// Kihachi:Nothing could match{newline}{endline}
static s16 scenario_text_0FE6[] = {
    CHR_K, CHR_i, CHR_h, CHR_a, CHR_c, CHR_h, CHR_i, PCT_COLON, CHR_N, CHR_o,
    CHR_t, CHR_h, CHR_i, CHR_n, CHR_g, PCT_SPACE, CHR_c, CHR_o, CHR_u, CHR_l,
    CHR_d, PCT_SPACE, CHR_m, CHR_a, CHR_t, CHR_c, CHR_h, CTR_NEWLINE, CTR_ENDLINE
};
...
s32 scenario_code_message_162_cd8c[] = {
    ...
    JFS, 0x37, (s32)&scenario_code_message_162_d41c,
    ...
    // ce08: Jump To @ce64
    JMP, (s32)&scenario_code_message_162_ce64,
    ...
    // ce20: Jump To @ced0
    JMP, (s32)&scenario_code_message_162_ced0,
    ...
    // ce38: Jump To @cf44
    JMP, (s32)&scenario_code_message_162_cf44,
    ...
    // ce50: Jump To @cfb0
    JMP, (s32)&scenario_code_message_162_cfb0,

    // ce58: Print Text
    TXT, (s32)&scenario_text_00C6,
...
s32 scenario_code_message_162_ce64[] = {
    ...
    // ce9c: Print Text
    TXT, (s32)&scenario_text_00F7,

    // cea4: Print Text
    TXT, (s32)&scenario_text_0038,

    // ceac: Print Text
    TXT, (s32)&scenario_text_0141,

    // ceb4: Print Text
    TXT, (s32)&scenario_text_016D,

    // cebc: Print Text
    TXT, (s32)&scenario_text_01AE,

    // cec4: Jump To @d024
    JMP, (s32)&scenario_code_message_162_d024,
...
s32 scenario_code_message_162_ced0[] = {
    ...
    // cf08: Print Text
    TXT, (s32)&scenario_text_01E7,

    // cf10: Print Text
    TXT, (s32)&scenario_text_0218,

    // cf18: Print Text
    TXT, (s32)&scenario_text_0038,

    // cf20: Print Text
    TXT, (s32)&scenario_text_0258,

    // cf28: Print Text
    TXT, (s32)&scenario_text_028D,

    // cf30: Print Text
    TXT, (s32)&scenario_text_02D2,
...
s32 scenario_code_message_162_cf44[] = {
    ...
    // cf7c: Print Text
    TXT, (s32)&scenario_text_031D,

    // cf84: Print Text
    TXT, (s32)&scenario_text_0038,

    // cf8c: Print Text
    TXT, (s32)&scenario_text_0368,

    // cf94: Print Text
    TXT, (s32)&scenario_text_0395,

    // cf9c: Print Text
    TXT, (s32)&scenario_text_03DB,
...
s32 scenario_code_message_162_cfb0[] = {
    ...
    // d000: Print Text
    TXT, (s32)&scenario_text_0488,

    // d008: Print Text
    TXT, (s32)&scenario_text_04BE,

    // d010: Print Text
    TXT, (s32)&scenario_text_0503,
...
s32 scenario_code_message_162_d024[] = {
    ...
    // d05c: Print Text
    TXT, (s32)&scenario_text_054D,

    // d064: Print Text
    TXT, (s32)&scenario_text_0573,

    // d06c: Print Text
    TXT, (s32)&scenario_text_05A8,

    // d074: Print Text
    TXT, (s32)&scenario_text_05ED,
    ...
    // d0b4: Print Text
    TXT, (s32)&scenario_text_062F,

    // d0bc: Print Text
    TXT, (s32)&scenario_text_065B,

    // d0c4: Print Text
    TXT, (s32)&scenario_text_0686,
    ...
    // d10c: Print Text
    TXT, (s32)&scenario_text_06D0,

    // d114: Print Text
    TXT, (s32)&scenario_text_06F7,

    // d11c: Print Text
    TXT, (s32)&scenario_text_0729,
    ...
    // d194: Print Text
    TXT, (s32)&scenario_text_089C,

    // d19c: Print Text
    TXT, (s32)&scenario_text_08CE,

    // d1a4: Print Text
    TXT, (s32)&scenario_text_0903,

    // d1ac: Print Text
    TXT, (s32)&scenario_text_0943,
    ...
    // d234: Print Text
    TXT, (s32)&scenario_text_09EE,

    // d23c: Print Text
    TXT, (s32)&scenario_text_0A20,

    // d244: Print Text
    TXT, (s32)&scenario_text_0A53,
    ...
    // d284: Print Text
    TXT, (s32)&scenario_text_0AAB,

    // d28c: Print Text
    TXT, (s32)&scenario_text_0AD7,
    ...
    // d2d4: Print Text
    TXT, (s32)&scenario_text_0B34,

    // d2dc: Print Text
    TXT, (s32)&scenario_text_0038,

    // d2e4: Print Text
    TXT, (s32)&scenario_text_0B73,

    // d2ec: Print Text
    TXT, (s32)&scenario_text_0BA7,

    // d2f4: Print Text
    TXT, (s32)&scenario_text_0BE5,
...
s32 scenario_code_message_162_d41c[] = {
    ...
    JFS, 0x38, (s32)&scenario_code_message_162_d45c,

    // d440: Print Text
    TXT, (s32)&scenario_text_0C36,
...
s32 scenario_code_message_162_d45c[] = {
    ...
    // d46c: Print Text
    TXT, (s32)&scenario_text_0C83,

    // d474: Print Text
    TXT, (s32)&scenario_text_0CBE,
...
s32 scenario_code_message_162_d490[] = {
    ...
    // d508: Print Text
    TXT, (s32)&scenario_text_0D5C,

    // d510: Print Text
    TXT, (s32)&scenario_text_0D8F,

    // d518: Print Text
    TXT, (s32)&scenario_text_0DCA,
    ...
    // d588: Print Text
    TXT, (s32)&scenario_text_0E39,

    // d590: Print Text
    TXT, (s32)&scenario_text_0E61,

    // d598: Print Text
    TXT, (s32)&scenario_text_0EA5,
...
s32 scenario_code_message_162_d63c[] = {
    ...
    // d644: Print Text
    TXT, (s32)&scenario_text_0F46,

    // d64c: Print Text
    TXT, (s32)&scenario_text_0F73,
    ...
    // d65c: Print Text
    TXT, (s32)&scenario_text_0FE6,

    // d664: Print Text
    TXT, (s32)&scenario_text_1017,
