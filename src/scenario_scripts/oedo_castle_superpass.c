...
static s16 scenario_text_002C[] = {
    ...
    CHR_d, PCT_SPACE, CHR_E, CHR_b, CHR_i, CHR_s, CHR_u, CHR_m, CHR_a, CHR_r,
    CHR_u, PCT_SPACE, CHR_r, CHR_e, CHR_c, CHR_e, CHR_i, CHR_v, CHR_e, CTR_NEWLINE,
    CTR_ENDLINE
};

//    a [{em-yellow}Super Pass{/em}] from the Lord!{endline}
static s16 scenario_text_005F[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_a, PCT_SPACE, PCT_LBRACKET, CTR_EM_YELLOW, CHR_S, CHR_u, CHR_p,
    CHR_e, CHR_r, PCT_SPACE, CHR_P, CHR_a, CHR_s, CHR_s, CTR_CLOSE_EM, PCT_RBRACKET, PCT_SPACE,
    CHR_f, CHR_r, CHR_o, CHR_m, PCT_SPACE, CHR_t, CHR_h, CHR_e, PCT_SPACE, CHR_L,
    CHR_o, CHR_r, CHR_d, PCT_EXCLAMATION, CTR_ENDLINE
};

// {end}{endline}
static s16 scenario_text_009C[] = {
    CTR_END, CTR_ENDLINE
};
...
static s16 scenario_text_00C2[] = {
    CHR_L, CHR_o, CHR_r, CHR_d, PCT_COLON, CHR_I, PCT_APOSTROPHE, CHR_m, PCT_SPACE, CHR_c,
    CHR_o, CHR_u, CHR_n, CHR_t, CHR_i, CHR_n, CHR_g, PCT_SPACE, CHR_o, CHR_n,
    PCT_SPACE, CHR_y, CHR_o, CHR_u, PCT_EXCLAMATION, CTR_ENDLINE
};
...
void replace_oedo_dialog_scenario(s32 scenario_id, s32 *scenario_code, s16 scenario_file_id)
{
...
RECOMP_HOOK("func_80000450_1050") void oedo_dialog_hook()
{
    // Try different possible scenario ID mappings
    replace_oedo_dialog_scenario(0x0ca, scenario_code_message_0ca_4b70, 0);
}
