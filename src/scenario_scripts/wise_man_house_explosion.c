...
static s16 scenario_text_0014[] = {
    CHR_G, CHR_o, CHR_e, CHR_m, CHR_o, CHR_n, PCT_COLON, CHR_S, CHR_e, CHR_e,
    PCT_SPACE, CHR_t, CHR_h, CHR_i, CHR_s, PCT_QUESTION, CTR_BUTTON, CTR_ENDLINE
};
...
static s16 scenario_text_0051[] = {
    ...
    CHR_s, PCT_SPACE, CHR_t, CHR_h, CHR_e, PCT_SPACE, CTR_EM_YELLOW, CHR_T, CHR_r, CHR_i,
    CHR_t, CHR_o, CHR_n, PCT_SPACE, CHR_S, CHR_h, CHR_e, CHR_l, CHR_l, CTR_CLOSE_EM,
...
static s16 scenario_text_0093[] = {
    ...
    PCT_SPACE, CHR_s, CHR_u, CHR_m, CHR_m, CHR_o, CHR_n, CHR_s, CTR_NEWLINE, CTR_ENDLINE
};

//       Gigantic Robot "{em-yellow}Impact{/em}"!!{newline}{endline}
static s16 scenario_text_00BB[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_G, CHR_i, CHR_g, CHR_a,
    CHR_n, CHR_t, CHR_i, CHR_c, PCT_SPACE, CHR_R, CHR_o, CHR_b, CHR_o, CHR_t,
    PCT_SPACE, PCT_QUOTE, CTR_EM_YELLOW, CHR_I, CHR_m, CHR_p, CHR_a, CHR_c, CHR_t, CTR_CLOSE_EM,
...
static s16 scenario_text_0100[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CTR_EM_YELLOW, CHR_W, CHR_i, CHR_s,
    CHR_e, PCT_SPACE, CHR_M, CHR_a, CHR_n, CTR_CLOSE_EM, PCT_SPACE, CHR_h, CHR_a, CHR_d,
    PCT_SPACE, CHR_i, CHR_t, PCT_PERIOD, PCT_PERIOD, PCT_PERIOD, CTR_BUTTON, CTR_ENDLINE
};

// {newwindow}{endline}
static s16 scenario_text_013D[] = {
    CTR_NEWWINDOW, CTR_ENDLINE
};
...
static s16 scenario_text_0155[] = {
    ...
    CHR_a, CHR_n, CHR_d, PCT_SPACE, CHR_s, CHR_o, PCT_SPACE, CHR_i, CHR_s, PCT_SPACE,
    CHR_t, CHR_h, CHR_i, CHR_s, PCT_SPACE, CHR_r, CHR_u, CHR_b, CHR_b, CHR_l,
...
static s16 scenario_text_018A[] = {
    ...
    CHR_t, CHR_h, CHR_a, CHR_t, PCT_SPACE, CHR_r, CHR_e, CHR_m, CHR_a, CHR_i,
    CHR_n, CHR_s, PCT_SPACE, CHR_o, CHR_f, CTR_NEWLINE, CTR_ENDLINE
};

//       {em-yellow}Wise Man's house{/em}?!{endline}
static s16 scenario_text_01B9[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CTR_EM_YELLOW, CHR_W, CHR_i, CHR_s,
    CHR_e, PCT_SPACE, CHR_M, CHR_a, CHR_n, PCT_APOSTROPHE, CHR_s, PCT_SPACE, CHR_h, CHR_o,
    CHR_u, CHR_s, CHR_e, CTR_CLOSE_EM, PCT_QUESTION, PCT_EXCLAMATION, CTR_ENDLINE
};

// {waitinput}{end}{endline}
static s16 scenario_text_01EE[] = {
...
static s16 scenario_text_021F[] = {
    ...
    CHR_H, CHR_e, CHR_y, PCT_EXCLAMATION, CTR_BUTTON, CTR_ENDLINE
};

// {newwindow}{endline}
static s16 scenario_text_0242[] = {
    CTR_NEWWINDOW, CTR_ENDLINE
};
...
static s16 scenario_text_025A[] = {
    ...
    CHR_e, PCT_SPACE, CTR_EM_YELLOW, CHR_T, CHR_r, CHR_i, CHR_t, CHR_o, CHR_n, PCT_SPACE,
    CHR_S, CHR_h, CHR_e, CHR_l, CHR_l, CTR_CLOSE_EM, CTR_NEWLINE, CTR_ENDLINE
};
...
static s16 scenario_text_02A2[] = {
    ...
    CHR_t, PCT_SPACE, CTR_EM_YELLOW, CHR_W, CHR_i, CHR_s, CHR_e, PCT_SPACE, CHR_M, CHR_a,
    CHR_n, CTR_CLOSE_EM, PCT_SPACE, CHR_h, CHR_a, CHR_d, PCT_SPACE, CHR_t, CHR_h, CHR_a,
    CHR_t, CTR_NEWLINE, CTR_ENDLINE
};

//        summons Gigantic Robot{newline}{endline}
static s16 scenario_text_02E5[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_s, CHR_u, CHR_m,
    CHR_m, CHR_o, CHR_n, CHR_s, PCT_SPACE, CHR_G, CHR_i, CHR_g, CHR_a, CHR_n,
    CHR_t, CHR_i, CHR_c, PCT_SPACE, CHR_R, CHR_o, CHR_b, CHR_o, CHR_t, CTR_NEWLINE,
    CTR_ENDLINE
};

//        "{em-yellow}Impact{/em}"...{button}{endline}
static s16 scenario_text_0318[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_QUOTE, CTR_EM_YELLOW, CHR_I,
    CHR_m, CHR_p, CHR_a, CHR_c, CHR_t, CTR_CLOSE_EM, PCT_QUOTE, PCT_PERIOD, PCT_PERIOD, PCT_PERIOD,
    CTR_BUTTON, CTR_ENDLINE
};

// {newwindow}{endline}
static s16 scenario_text_034F[] = {
    CTR_NEWWINDOW, CTR_ENDLINE
};
...
static s16 scenario_text_0367[] = {
    CHR_E, CHR_b, CHR_i, CHR_s, CHR_u, CHR_m, CHR_a, CHR_r, CHR_u, PCT_COLON,
    PCT_PERIOD, PCT_PERIOD, PCT_PERIOD, CHR_w, CHR_a, CHR_i, CHR_t, PCT_EXCLAMATION, CTR_NEWLINE, CTR_ENDLINE
};

//        That would mean{newline}{endline}
static s16 scenario_text_038F[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_T, CHR_h, CHR_a,
    CHR_t, PCT_SPACE, CHR_w, CHR_o, CHR_u, CHR_l, CHR_d, PCT_SPACE, CHR_m, CHR_e,
...
static s16 scenario_text_03BB[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_t, CHR_h, CHR_a,
    CHR_t, PCT_SPACE, CHR_t, CHR_h, CHR_i, CHR_s, PCT_SPACE, CHR_h, CHR_e, CHR_r,
    CHR_e, PCT_SPACE, CHR_i, CHR_s, CTR_NEWLINE, CTR_ENDLINE
};

//        {em-yellow}Wise Man's house{/em}!{endline}
static s16 scenario_text_03E9[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CTR_EM_YELLOW, CHR_W, CHR_i,
    CHR_s, CHR_e, PCT_SPACE, CHR_M, CHR_a, CHR_n, PCT_APOSTROPHE, CHR_s, PCT_SPACE, CHR_h,
    CHR_o, CHR_u, CHR_s, CHR_e, CTR_CLOSE_EM, PCT_EXCLAMATION, CTR_ENDLINE
};
...
s32 scenario_code_message_1cd_185c[] = {
    ...
    // 1884: Jump To @1920
    JMP, (s32)&scenario_code_message_1cd_1920,
    ...
    // 18ec: Print Text
    TXT, (s32)&scenario_text_0155,

    // 18f4: Print Text
    TXT, (s32)&scenario_text_018A,

    // 18fc: Print Text
    TXT, (s32)&scenario_text_01B9,
...
s32 scenario_code_message_1cd_1920[] = {
    ...
    // 1948: Print Text
    TXT, (s32)&scenario_text_021F,

    // 1950: Print Text
    TXT, (s32)&scenario_text_0039,

    // 1958: Print Text
    TXT, (s32)&scenario_text_025A,

    // 1960: Print Text
    TXT, (s32)&scenario_text_02A2,

    // 1968: Print Text
    TXT, (s32)&scenario_text_02E5,

    // 1970: Print Text
    TXT, (s32)&scenario_text_0318,

    // 1978: Print Text
    TXT, (s32)&scenario_text_0039,

    // 1980: Print Text
    TXT, (s32)&scenario_text_0367,

    // 1988: Print Text
    TXT, (s32)&scenario_text_038F,
