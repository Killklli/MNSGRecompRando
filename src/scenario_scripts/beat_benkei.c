...
static s16 scenario_text_0014[] = {
    ...
    PCT_COLON, CHR_W, CHR_h, CHR_i, CHR_c, CHR_h,
    PCT_SPACE, CHR_i, CHR_s, PCT_QUESTION, CTR_BUTTON, CTR_ENDLINE};
...
static s16 scenario_text_0051[] = {
    ...
    CHR_w, PCT_COMMA, PCT_SPACE, CHR_w, CHR_o, CHR_w,
...
static s16 scenario_text_007A[] = {
    ...
    CHR_s, PCT_SPACE, CHR_o, CHR_u, CHR_r,
    PCT_SPACE, CHR_f, CHR_r, CHR_i, CHR_e,
    CHR_n, CHR_d, PCT_COMMA, PCT_SPACE, CTR_EM_YELLOW,
    CHR_S, CHR_a, CHR_s, CHR_u, CHR_k,
    CHR_e, CTR_CLOSE_EM, PCT_EXCLAMATION, CTR_BUTTON, CTR_ENDLINE};

// {end}{endline}
static s16 scenario_text_00BE[] = {CTR_END, CTR_ENDLINE};

// {begin}{endline}
static s16 scenario_text_00D0[] = {CTR_BEGIN, CTR_ENDLINE};

// Narrator:What Benkei pulled out{newline}{endline}
static s16 scenario_text_00E4[] = {
    CHR_N, CHR_a, CHR_r, CHR_r, CHR_a, CHR_t, CHR_o,
    CHR_r, PCT_COLON, CHR_W, CHR_h, CHR_a, CHR_t, PCT_SPACE,
    CHR_B, CHR_e, CHR_n, CHR_k, CHR_e, CHR_i, PCT_SPACE,
    CHR_p, CHR_u, CHR_l, CHR_l, CHR_e, CHR_d, PCT_SPACE,
    CHR_o, CHR_u, CHR_t, CTR_NEWLINE, CTR_ENDLINE};

//        was...{button}{endline}
static s16 scenario_text_0119[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    PCT_SPACE, PCT_SPACE, CHR_w, CHR_a, CHR_s,
    PCT_PERIOD, PCT_PERIOD, PCT_PERIOD, CTR_BUTTON, CTR_ENDLINE};

// {newwindow}{endline}
static s16 scenario_text_013B[] = {CTR_NEWWINDOW, CTR_ENDLINE};

// Narrator:...all stiff,{newline}{endline}
static s16 scenario_text_0153[] = {
    CHR_N, CHR_a, CHR_r, CHR_r, CHR_a, CHR_t,
    CHR_o, CHR_r, PCT_COLON, PCT_PERIOD, PCT_PERIOD, PCT_PERIOD,
    CHR_a, CHR_l, CHR_l, PCT_SPACE, CHR_s, CHR_t,
    CHR_i, CHR_f, CHR_f, PCT_COMMA, CTR_NEWLINE, CTR_ENDLINE};
...
static s16 scenario_text_017F[] = {
    ...
    CHR_w, CHR_i, CHR_t, CHR_h, PCT_SPACE, PCT_LBRACKET,
    CTR_EM_YELLOW, CHR_b, CHR_a, CHR_t, CHR_t, CHR_e,
    CHR_r, CHR_i, CHR_e, CHR_s, CTR_CLOSE_EM, PCT_RBRACKET,
    CTR_NEWLINE, CTR_ENDLINE};

//        almost falling out...{button}{endline}
static s16 scenario_text_01BB[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    PCT_SPACE, CHR_a, CHR_l, CHR_m, CHR_o, CHR_s,
    CHR_t, PCT_SPACE, CHR_f, CHR_a, CHR_l, CHR_l,
    CHR_i, CHR_n, CHR_g, PCT_SPACE, CHR_o, CHR_u,
    CHR_t, PCT_PERIOD, PCT_PERIOD, PCT_PERIOD, CTR_BUTTON, CTR_ENDLINE};

// {newwindow}{endline}
static s16 scenario_text_01EC[] = {CTR_NEWWINDOW, CTR_ENDLINE};

// Narrator:It was none other than{newline}{endline}
static s16 scenario_text_0204[] = {
    CHR_N, CHR_a, CHR_r, CHR_r, CHR_a, CHR_t, CHR_o,
    CHR_r, PCT_COLON, CHR_I, CHR_t, PCT_SPACE, CHR_w, CHR_a,
    CHR_s, PCT_SPACE, CHR_n, CHR_o, CHR_n, CHR_e, PCT_SPACE,
    CHR_o, CHR_t, CHR_h, CHR_e, CHR_r, PCT_SPACE, CHR_t,
    CHR_h, CHR_a, CHR_n, CTR_NEWLINE, CTR_ENDLINE};

//        the Mechanical Ninja,{newline}{endline}
static s16 scenario_text_0239[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    PCT_SPACE, CHR_t, CHR_h, CHR_e, PCT_SPACE, CHR_M,
    CHR_e, CHR_c, CHR_h, CHR_a, CHR_n, CHR_i,
    CHR_c, CHR_a, CHR_l, PCT_SPACE, CHR_N, CHR_i,
    CHR_n, CHR_j, CHR_a, PCT_COMMA, CTR_NEWLINE, CTR_ENDLINE};

//        {em-yellow}Sasuke{/em}!{button}{end}{endline}
static s16 scenario_text_026B[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    PCT_SPACE, PCT_SPACE, CTR_EM_YELLOW, CHR_S, CHR_a,
    CHR_s, CHR_u, CHR_k, CHR_e, CTR_CLOSE_EM,
    PCT_EXCLAMATION, CTR_BUTTON, CTR_END, CTR_ENDLINE};

// {begin}{endline}
static s16 scenario_text_02A3[] = {CTR_BEGIN, CTR_ENDLINE};

// Yae:Where did you get this?!{button}{end}{endline}
static s16 scenario_text_02B7[] = {
    CHR_Y, CHR_a, CHR_e, PCT_COLON, CHR_W, CHR_h,
    CHR_e, CHR_r, CHR_e, PCT_SPACE, CHR_d, CHR_i,
    CHR_d, PCT_SPACE, CHR_y, CHR_o, CHR_u, PCT_SPACE,
    CHR_g, CHR_e, CHR_t, PCT_SPACE, CHR_t, CHR_h,
    CHR_i, CHR_s, PCT_QUESTION, PCT_EXCLAMATION, CTR_BUTTON, CTR_END,
    CTR_ENDLINE};

// {begin}{endline}
static s16 scenario_text_02ED[] = {CTR_BEGIN, CTR_ENDLINE};

// Benkei:It came falling from {newline}{endline}
static s16 scenario_text_0301[] = {
    CHR_B, CHR_e, CHR_n, CHR_k, CHR_e, CHR_i,
    PCT_COLON, CHR_I, CHR_t, PCT_SPACE, CHR_c, CHR_a,
    CHR_m, CHR_e, PCT_SPACE, CHR_f, CHR_a, CHR_l,
    CHR_l, CHR_i, CHR_n, CHR_g, PCT_SPACE, CHR_f,
    CHR_r, CHR_o, CHR_m, PCT_SPACE, CTR_NEWLINE, CTR_ENDLINE};
...
static s16 scenario_text_0333[] = {
    ...
    CHR_k, CHR_y, CTR_CLOSE_EM, PCT_SPACE, CHR_j, CHR_u,
    CHR_s, CHR_t, PCT_SPACE, CHR_t, CHR_h, CHR_e,
    PCT_SPACE, CHR_o, CHR_t, CHR_h, CHR_e, CHR_r,
    PCT_SPACE, CHR_d, CHR_a, CHR_y, PCT_PERIOD, CTR_BUTTON,
    CTR_END, CTR_ENDLINE};

// {begin}{endline}
static s16 scenario_text_037E[] = {CTR_BEGIN, CTR_ENDLINE};

// Goemon:I wonder if it has anything{newline}{endline}
static s16 scenario_text_0392[] = {
    CHR_G, CHR_o, CHR_e, CHR_m, CHR_o, CHR_n,
    PCT_COLON, CHR_I, PCT_SPACE, CHR_w, CHR_o, CHR_n,
    CHR_d, CHR_e, CHR_r, PCT_SPACE, CHR_i, CHR_f,
    PCT_SPACE, CHR_i, CHR_t, PCT_SPACE, CHR_h, CHR_a,
    CHR_s, PCT_SPACE, CHR_a, CHR_n, CHR_y, CHR_t,
    CHR_h, CHR_i, CHR_n, CHR_g, CTR_NEWLINE, CTR_ENDLINE};

//       to do with the explosion{newline}{endline}
static s16 scenario_text_03CA[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    CHR_t, CHR_o, PCT_SPACE, CHR_d, CHR_o, PCT_SPACE,
    CHR_w, CHR_i, CHR_t, CHR_h, PCT_SPACE, CHR_t,
    CHR_h, CHR_e, PCT_SPACE, CHR_e, CHR_x, CHR_p,
    CHR_l, CHR_o, CHR_s, CHR_i, CHR_o, CHR_n,
    CTR_NEWLINE, CTR_ENDLINE};
...
static s16 scenario_text_03FE[] = {
    ...
    CHR_i, CHR_s, CHR_e, PCT_SPACE, CHR_M,
    CHR_a, CHR_n, PCT_APOSTROPHE, CHR_s, PCT_SPACE,
    CHR_h, CHR_o, CHR_u, CHR_s, CHR_e,
    CTR_CLOSE_EM, PCT_PERIOD, PCT_PERIOD, PCT_PERIOD, CTR_BUTTON,
    CTR_END, CTR_ENDLINE};

// {begin}{endline}
static s16 scenario_text_0448[] = {CTR_BEGIN, CTR_ENDLINE};

// Benkei:Well, in any case,{newline}{endline}
static s16 scenario_text_045C[] = {
    CHR_B, CHR_e, CHR_n, CHR_k, CHR_e, CHR_i, PCT_COLON,
    CHR_W, CHR_e, CHR_l, CHR_l, PCT_COMMA, PCT_SPACE, CHR_i,
    CHR_n, PCT_SPACE, CHR_a, CHR_n, CHR_y, PCT_SPACE, CHR_c,
    CHR_a, CHR_s, CHR_e, PCT_COMMA, CTR_NEWLINE, CTR_ENDLINE};

//       don't tell a single soul{newline}{endline}
static s16 scenario_text_048B[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    CHR_d, CHR_o, CHR_n, PCT_APOSTROPHE, CHR_t, PCT_SPACE,
    CHR_t, CHR_e, CHR_l, CHR_l, PCT_SPACE, CHR_a,
    PCT_SPACE, CHR_s, CHR_i, CHR_n, CHR_g, CHR_l,
    CHR_e, PCT_SPACE, CHR_s, CHR_o, CHR_u, CHR_l,
    CTR_NEWLINE, CTR_ENDLINE};

//       that I lost!{button}{end}{endline}
static s16 scenario_text_04BF[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    CHR_t, CHR_h, CHR_a, CHR_t, PCT_SPACE, CHR_I,
    PCT_SPACE, CHR_l, CHR_o, CHR_s, CHR_t, PCT_EXCLAMATION,
    CTR_BUTTON, CTR_END, CTR_ENDLINE};

// {begin}{endline}
static s16 scenario_text_04EB[] = {CTR_BEGIN, CTR_ENDLINE};

//   {newline}{endline}
static s16 scenario_text_04FF[] = {PCT_SPACE, PCT_SPACE, CTR_NEWLINE,
                                   CTR_ENDLINE};
...
static s16 scenario_text_0517[] = {
    ...
    CHR_i, CHR_e, CHR_s, PCT_SPACE, CHR_r, CHR_e, CHR_c,
    CHR_e, CHR_i, CHR_v, CHR_e, CTR_NEWLINE, CTR_ENDLINE};
...
static s16 scenario_text_0546[] = {
    ...
    CHR_h, CHR_e, PCT_SPACE, CHR_M, CHR_e,
    CHR_c, CHR_h, CHR_a, CHR_n, CHR_i,
    CHR_c, CHR_a, CHR_l, PCT_SPACE, CHR_N,
    CHR_i, CHR_n, CHR_j, CHR_a, PCT_SPACE,
    PCT_LBRACKET, CTR_EM_YELLOW, CHR_S, CHR_a, CHR_s,
    CHR_u, CHR_k, CHR_e, CTR_CLOSE_EM, PCT_RBRACKET,
    PCT_PERIOD, CTR_ENDLINE};

// {end}{endline}
static s16 scenario_text_0585[] = {CTR_END, CTR_ENDLINE};
...
s32 scenario_code_message_30e_251c[] = {
    ...
    // 259c: Print Text
    TXT,
    (s32)&scenario_text_007A,

    // 25a4: Print Text
    TXT,
    (s32)&scenario_text_00BE,
    ...
    // 2614: Print Text
    TXT,
    (s32)&scenario_text_00E4,

    // 261c: Print Text
    TXT,
    (s32)&scenario_text_0119,
    ...
    // 2634: Print Text
    TXT,
    (s32)&scenario_text_017F,

    // 263c: Print Text
    TXT,
    (s32)&scenario_text_01BB,
    ...
    // 271c: Print Text
    TXT,
    (s32)&scenario_text_0301,

    // 2724: Print Text
    TXT,
    (s32)&scenario_text_0333,
    ...
    // 2784: Print Text
    TXT,
    (s32)&scenario_text_0392,

    // 278c: Print Text
    TXT,
    (s32)&scenario_text_03CA,

    // 2794: Print Text
    TXT,
    (s32)&scenario_text_03FE,
    ...
    // 286c: Print Text
    TXT,
    (s32)&scenario_text_04FF,

    // 2874: Print Text
    TXT,
    (s32)&scenario_text_0517,

    // 287c: Print Text
    TXT,
    (s32)&scenario_text_0546,
