...
static s16 scenario_text_0014[] = {
    PCT_LBRACKET, CHR_W, CHR_a, CHR_t, CHR_e, CHR_r,
    CHR_f, CHR_a, CHR_l, CHR_l, PCT_SPACE, CHR_o,
    CHR_f, PCT_SPACE, CHR_K, CHR_e, CHR_g, CHR_o,
    CHR_n, PCT_RBRACKET, CTR_NEWLINE, CTR_ENDLINE};

// Legend has it that those {newline}{endline}
static s16 scenario_text_003E[] = {
    CHR_L, CHR_e, CHR_g, CHR_e, CHR_n, CHR_d, PCT_SPACE,
    CHR_h, CHR_a, CHR_s, PCT_SPACE, CHR_i, CHR_t, PCT_SPACE,
    CHR_t, CHR_h, CHR_a, CHR_t, PCT_SPACE, CHR_t, CHR_h,
    CHR_o, CHR_s, CHR_e, PCT_SPACE, CTR_NEWLINE, CTR_ENDLINE};

// who successfully swim to the top{newline}{endline}
static s16 scenario_text_006D[] = {
    CHR_w, CHR_h, CHR_o, PCT_SPACE, CHR_s, CHR_u, CHR_c,
    CHR_c, CHR_e, CHR_s, CHR_s, CHR_f, CHR_u, CHR_l,
    CHR_l, CHR_y, PCT_SPACE, CHR_s, CHR_w, CHR_i, CHR_m,
    PCT_SPACE, CHR_t, CHR_o, PCT_SPACE, CHR_t, CHR_h, CHR_e,
    PCT_SPACE, CHR_t, CHR_o, CHR_p, CTR_NEWLINE, CTR_ENDLINE};

// of this {em-yellow}waterfall{/em}...{button}{endline}
static s16 scenario_text_00A3[] = {
    CHR_o, CHR_f, PCT_SPACE, CHR_t, CHR_h,
    CHR_i, CHR_s, PCT_SPACE, CTR_EM_YELLOW, CHR_w,
    CHR_a, CHR_t, CHR_e, CHR_r, CHR_f,
    CHR_a, CHR_l, CHR_l, CTR_CLOSE_EM, PCT_PERIOD,
    PCT_PERIOD, PCT_PERIOD, CTR_BUTTON, CTR_ENDLINE};

// {newwindow}{endline}
static s16 scenario_text_00DC[] = {CTR_NEWWINDOW, CTR_ENDLINE};
...
static s16 scenario_text_011E[] = {
    PCT_PERIOD, PCT_PERIOD, PCT_PERIOD, CHR_c, CHR_a, CHR_n,
    PCT_SPACE, CHR_b, CHR_e, CHR_c, CHR_o, CHR_m,
    CHR_e, PCT_SPACE, CHR_a, PCT_SPACE, CTR_EM_YELLOW, CHR_m,
    CHR_e, CHR_r, CHR_m, CHR_a, CHR_i, CHR_d,
...
static s16 scenario_text_019D[] = {
    PCT_LPAREN, CHR_I, CHR_t, PCT_SPACE, CHR_m, CHR_a,
    CHR_y, PCT_SPACE, CHR_s, CHR_t, CHR_i, CHR_l,
    CHR_l, PCT_SPACE, CHR_b, CHR_e, PCT_SPACE, CHR_t,
    CHR_o, CHR_o, PCT_SPACE, CHR_e, CHR_a, CHR_r,
    CHR_l, CHR_y, PCT_SPACE, CTR_NEWLINE, CTR_ENDLINE};

//      for you to arrive here){endline}
static s16 scenario_text_01CE[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, CHR_f,
    CHR_o, CHR_r, PCT_SPACE, CHR_y, CHR_o, CHR_u,
    PCT_SPACE, CHR_t, CHR_o, PCT_SPACE, CHR_a, CHR_r,
    CHR_r, CHR_i, CHR_v, CHR_e, PCT_SPACE, CHR_h,
    CHR_e, CHR_r, CHR_e, PCT_RPAREN, CTR_ENDLINE};

// {waitinput}{end}{endline}
static s16 scenario_text_01F7[] = {CTR_WAITINPUT, CTR_END, CTR_ENDLINE};
...
static s16 scenario_text_0214[] = {
    ...
    PCT_COLON, CHR_T, CHR_a, CHR_k, CHR_e, PCT_SPACE, CHR_c, CHR_o,
    CHR_n, CHR_t, CHR_r, CHR_o, CHR_l, PCT_SPACE, CHR_o, CHR_f,
...
static s16 scenario_text_0246[] = {
    ...
    PCT_SPACE, PCT_SPACE, CTR_EM_YELLOW, CHR_L, CHR_e,
    CHR_g, CHR_e, CHR_n, CHR_d, PCT_SPACE,
    CHR_o, CHR_f, PCT_SPACE, CHR_t, CHR_h,
    CHR_e, PCT_SPACE, CHR_M, CHR_e, CHR_r,
    CHR_m, CHR_a, CHR_i, CHR_d, CTR_CLOSE_EM,
...
static s16 scenario_text_0289[] = {
    ...
    PCT_SPACE, CHR_L, CHR_o, CHR_o, CHR_k, CHR_i,
    CHR_n, CHR_g, PCT_SPACE, CHR_f, CHR_o, CHR_r,
    PCT_SPACE, CHR_a, CHR_p, CHR_p, CHR_l, CHR_i,
    CHR_c, CHR_a, CHR_n, CHR_t, CHR_s, PCT_EXCLAMATION,
    CTR_BUTTON, CTR_ENDLINE};

// {newwindow}{endline}
static s16 scenario_text_02BC[] = {CTR_NEWWINDOW, CTR_ENDLINE};

// Do you wish to challenge{newline}{endline}
static s16 scenario_text_02D4[] = {
    CHR_D, CHR_o, PCT_SPACE, CHR_y, CHR_o, CHR_u, PCT_SPACE,
    CHR_w, CHR_i, CHR_s, CHR_h, PCT_SPACE, CHR_t, CHR_o,
...
static s16 scenario_text_0302[] = {
    CHR_t, CHR_h, CHR_e, PCT_SPACE, CHR_L, CHR_e, CHR_g,
    CHR_e, CHR_n, CHR_d, PCT_QUESTION, CTR_NEWLINE, CTR_ENDLINE};

//   {em-yellow}Yes, I do!{newline}{endline}
static s16 scenario_text_0323[] = {
    PCT_SPACE, PCT_SPACE, CTR_EM_YELLOW, CHR_Y, CHR_e,
    CHR_s, PCT_COMMA, PCT_SPACE, CHR_I, PCT_SPACE,
...
static s16 scenario_text_0350[] = {
    PCT_SPACE, PCT_SPACE, CTR_EM_YELLOW, CHR_I, PCT_APOSTROPHE, CHR_m,
    PCT_SPACE, CHR_g, CHR_o, CHR_i, CHR_n, CHR_g,
    PCT_SPACE, CHR_t, CHR_o, PCT_SPACE, CHR_p, CHR_a,
    CHR_s, CHR_s, PCT_SPACE, CHR_o, CHR_n, PCT_SPACE,
    CHR_t, CHR_h, CHR_i, CHR_s, PCT_SPACE, CHR_o,
    CHR_n, CHR_e, PCT_PERIOD, CTR_NEWLINE, CTR_ENDLINE};

// {end}{endline}
static s16 scenario_text_0391[] = {CTR_END, CTR_ENDLINE};

// Address: @2cb0

// {newwindow}{endline}
static s16 scenario_text_03A3[] = {CTR_NEWWINDOW, CTR_ENDLINE};

// {/em}If you say so.{newline}{endline}
static s16 scenario_text_03BB[] = {
    CTR_CLOSE_EM, CHR_I, CHR_f, PCT_SPACE, CHR_y, CHR_o,
    CHR_u, PCT_SPACE, CHR_s, CHR_a, CHR_y, PCT_SPACE,
    CHR_s, CHR_o, PCT_PERIOD, CTR_NEWLINE, CTR_ENDLINE};

// Come back if you change{newline}{endline}
static s16 scenario_text_03E4[] = {
    CHR_C, CHR_o, CHR_m, CHR_e, PCT_SPACE, CHR_b, CHR_a,
    CHR_c, CHR_k, PCT_SPACE, CHR_i, CHR_f, PCT_SPACE, CHR_y,
    CHR_o, CHR_u, PCT_SPACE, CHR_c, CHR_h, CHR_a, CHR_n,
    CHR_g, CHR_e, CTR_NEWLINE, CTR_ENDLINE};

// your mind.{endline}
static s16 scenario_text_0411[] = {CHR_y, CHR_o, CHR_u, CHR_r,
                                   PCT_SPACE, CHR_m, CHR_i, CHR_n,
                                   CHR_d, PCT_PERIOD, CTR_ENDLINE};

// {waitinput}{end}{endline}
static s16 scenario_text_0428[] = {CTR_WAITINPUT, CTR_END, CTR_ENDLINE};

// Address: @2cdc

// {newwindow}{endline}
static s16 scenario_text_0445[] = {CTR_NEWWINDOW, CTR_ENDLINE};

// {/em}Narrator:Are you ready?!{endline}
static s16 scenario_text_045D[] = {
    CTR_CLOSE_EM, CHR_N, CHR_a, CHR_r, CHR_r, CHR_a,
    CHR_t, CHR_o, CHR_r, PCT_COLON, CHR_A, CHR_r,
    CHR_e, PCT_SPACE, CHR_y, CHR_o, CHR_u, PCT_SPACE,
    CHR_r, CHR_e, CHR_a, CHR_d, CHR_y, PCT_QUESTION,
    PCT_EXCLAMATION, CTR_ENDLINE};

// {waitinput}{end}{endline}
static s16 scenario_text_0487[] = {CTR_WAITINPUT, CTR_END, CTR_ENDLINE};
...
static s16 scenario_text_04A4[] = {
    ...
    CHR_t, CHR_o, PCT_SPACE, CHR_t, CHR_r, CHR_y,
    PCT_SPACE, CHR_a, CHR_g, CHR_a, CHR_i, CHR_n,
    PCT_QUESTION, CTR_NEWLINE, CTR_ENDLINE};

//   {newline}{endline}
static s16 scenario_text_04D3[] = {PCT_SPACE, PCT_SPACE, CTR_NEWLINE,
                                   CTR_ENDLINE};

//   {em-yellow}Yes!{newline}{endline}
static s16 scenario_text_04EB[] = {PCT_SPACE, PCT_SPACE, CTR_EM_YELLOW,
                                   CHR_Y, CHR_e, CHR_s,
                                   PCT_EXCLAMATION, CTR_NEWLINE, CTR_ENDLINE};
...
static s16 scenario_text_0512[] = {
    ...
    PCT_SPACE, CHR_I, PCT_APOSTROPHE, CHR_d, PCT_SPACE, CHR_r,
    CHR_a, CHR_t, CHR_h, CHR_e, CHR_r, PCT_SPACE,
    CHR_n, CHR_o, CHR_t, PCT_PERIOD, CTR_NEWLINE, CTR_ENDLINE};

// {end}{endline}
static s16 scenario_text_0548[] = {CTR_END, CTR_ENDLINE};

// Address: @2fe8

// {newwindow}{endline}
static s16 scenario_text_055A[] = {CTR_NEWWINDOW, CTR_ENDLINE};

// {/em}Narrator:I dread the thought of{newline}{endline}
static s16 scenario_text_0572[] = {
    CTR_CLOSE_EM, CHR_N, CHR_a, CHR_r, CHR_r, CHR_a, CHR_t, CHR_o,
    CHR_r, PCT_COLON, CHR_I, PCT_SPACE, CHR_d, CHR_r, CHR_e, CHR_a,
    CHR_d, PCT_SPACE, CHR_t, CHR_h, CHR_e, PCT_SPACE, CHR_t, CHR_h,
    CHR_o, CHR_u, CHR_g, CHR_h, CHR_t, PCT_SPACE, CHR_o, CHR_f,
    CTR_NEWLINE, CTR_ENDLINE};

//        seeing a {em-yellow}male{/em} mermaid.{endline}
static s16 scenario_text_05AC[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    PCT_SPACE, CHR_s, CHR_e, CHR_e, CHR_i, CHR_n,
    CHR_g, PCT_SPACE, CHR_a, PCT_SPACE, CTR_EM_YELLOW, CHR_m,
    CHR_a, CHR_l, CHR_e, CTR_CLOSE_EM, PCT_SPACE, CHR_m,
    CHR_e, CHR_r, CHR_m, CHR_a, CHR_i, CHR_d,
    PCT_PERIOD, CTR_ENDLINE};

// {waitinput}{end}{endline}
static s16 scenario_text_05E6[] = {CTR_WAITINPUT, CTR_END, CTR_ENDLINE};

// Address: @301c

// {begin}{endline}
static s16 scenario_text_0603[] = {CTR_BEGIN, CTR_ENDLINE};

//  {newline}{endline}
static s16 scenario_text_0617[] = {PCT_SPACE, CTR_NEWLINE, CTR_ENDLINE};
...
static s16 scenario_text_062E[] = {
    ...
    CTR_EM_YELLOW, CHR_B, CHR_E, CHR_A, CHR_U,
    CHR_T, CHR_I, CHR_F, CHR_U, CHR_L,
...
static s16 scenario_text_0665[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    PCT_SPACE, PCT_SPACE, CHR_D, CHR_O, CHR_N,
    CHR_E, PCT_EXCLAMATION, PCT_EXCLAMATION, PCT_SPACE, CTR_CLOSE_EM,
    CTR_CLOSE_BLINK, CTR_BUTTON, CTR_ENDLINE};

// {newwindow}{endline}
static s16 scenario_text_069A[] = {CTR_NEWWINDOW, CTR_ENDLINE};

// Narrator:Your gracious swimming{newline}{endline}
static s16 scenario_text_06B2[] = {
    CHR_N, CHR_a, CHR_r, CHR_r, CHR_a, CHR_t, CHR_o,
    CHR_r, PCT_COLON, CHR_Y, CHR_o, CHR_u, CHR_r, PCT_SPACE,
    CHR_g, CHR_r, CHR_a, CHR_c, CHR_i, CHR_o, CHR_u,
    CHR_s, PCT_SPACE, CHR_s, CHR_w, CHR_i, CHR_m, CHR_m,
    CHR_i, CHR_n, CHR_g, CTR_NEWLINE, CTR_ENDLINE};

//        skills are like that of{newline}{endline}
static s16 scenario_text_06E7[] = {
    PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE, PCT_SPACE,
    PCT_SPACE, CHR_s, CHR_k, CHR_i, CHR_l, CHR_l,
    CHR_s, PCT_SPACE, CHR_a, CHR_r, CHR_e, PCT_SPACE,
    CHR_l, CHR_i, CHR_k, CHR_e, PCT_SPACE, CHR_t,
    CHR_h, CHR_a, CHR_t, PCT_SPACE, CHR_o, CHR_f,
    CTR_NEWLINE, CTR_ENDLINE};
...
static s16 scenario_text_071B[] = {
    ...
    CHR_M, CHR_e, CHR_r, CHR_m, CHR_a, CHR_i,
    CHR_d, PCT_SPACE, CHR_P, CHR_r, CHR_i, CHR_n,
    CHR_c, CHR_e, CHR_s, CHR_s, CTR_CLOSE_EM, PCT_EXCLAMATION,
    CTR_BUTTON, CTR_ENDLINE};

// {newwindow}{endline}
static s16 scenario_text_075C[] = {CTR_NEWWINDOW, CTR_ENDLINE};

// {end}{endline}
static s16 scenario_text_0774[] = {CTR_END, CTR_ENDLINE};

// {begin}{endline}
static s16 scenario_text_0786[] = {CTR_BEGIN, CTR_ENDLINE};

//  {newline}{endline}
static s16 scenario_text_079A[] = {PCT_SPACE, CTR_NEWLINE, CTR_ENDLINE};

// Yae obtains{newline}{endline}
static s16 scenario_text_07B1[] = {
    CHR_Y, CHR_a, CHR_e, PCT_SPACE, CHR_o, CHR_b, CHR_t,
...
static s16 scenario_text_07D2[] = {
    ...
    CHR_d, CTR_CLOSE_EM, PCT_RBRACKET, PCT_SPACE, CHR_m,
    CHR_a, CHR_g, CHR_i, CHR_c, PCT_SPACE,
    CHR_p, CHR_o, CHR_w, CHR_e, CHR_r,
    CHR_s, PCT_EXCLAMATION, CTR_BUTTON, CTR_ENDLINE};

// {newwindow}{endline}
static s16 scenario_text_0815[] = {CTR_NEWWINDOW, CTR_ENDLINE};

//  {newline}{endline}
static s16 scenario_text_082D[] = {PCT_SPACE, CTR_NEWLINE, CTR_ENDLINE};

// Now you can swim {em-yellow}underwater{/em} in{newline}{endline}
static s16 scenario_text_0844[] = {
    CHR_N, CHR_o, CHR_w, PCT_SPACE, CHR_y, CHR_o,
    CHR_u, PCT_SPACE, CHR_c, CHR_a, CHR_n, PCT_SPACE,
    CHR_s, CHR_w, CHR_i, CHR_m, PCT_SPACE, CTR_EM_YELLOW,
    CHR_u, CHR_n, CHR_d, CHR_e, CHR_r, CHR_w,
    CHR_a, CHR_t, CHR_e, CHR_r, CTR_CLOSE_EM, PCT_SPACE,
    CHR_i, CHR_n, CTR_NEWLINE, CTR_ENDLINE};

// the deep ocean and rivers!{endline}
static s16 scenario_text_0888[] = {
    CHR_t, CHR_h, CHR_e, PCT_SPACE, CHR_d, CHR_e, CHR_e,
    CHR_p, PCT_SPACE, CHR_o, CHR_c, CHR_e, CHR_a, CHR_n,
    PCT_SPACE, CHR_a, CHR_n, CHR_d, PCT_SPACE, CHR_r, CHR_i,
    CHR_v, CHR_e, CHR_r, CHR_s, PCT_EXCLAMATION, CTR_ENDLINE};

// {waitinput}{end}{endline}
static s16 scenario_text_08AF[] = {CTR_WAITINPUT, CTR_END, CTR_ENDLINE};

// Address: @31ec

// {newwindow}{endline}
static s16 scenario_text_08CC[] = {CTR_NEWWINDOW, CTR_ENDLINE};
...
static s16 scenario_text_090E[] = {
    CHR_I, PCT_SPACE, CHR_h, CHR_e, CHR_a, CHR_r,
    PCT_SPACE, CHR_t, CHR_h, CHR_a, CHR_t, PCT_SPACE,
    CHR_r, CHR_e, CHR_c, CHR_e, CHR_n, CHR_t,
    CHR_l, CHR_y, PCT_SPACE, CHR_s, CHR_o, CHR_m,
    CHR_e, CHR_o, CHR_n, CHR_e, CTR_NEWLINE, CTR_ENDLINE};

// swam up this waterfall,{newline}{endline}
static s16 scenario_text_0940[] = {
    CHR_s, CHR_w, CHR_a, CHR_m, PCT_SPACE, CHR_u, CHR_p,
    PCT_SPACE, CHR_t, CHR_h, CHR_i, CHR_s, PCT_SPACE, CHR_w,
    CHR_a, CHR_t, CHR_e, CHR_r, CHR_f, CHR_a, CHR_l,
    CHR_l, PCT_COMMA, CTR_NEWLINE, CTR_ENDLINE};

// and became a beautiful {em-yellow}mermaid{/em}.{endline}
static s16 scenario_text_096D[] = {
    CHR_a, CHR_n, CHR_d, PCT_SPACE, CHR_b, CHR_e,
    CHR_c, CHR_a, CHR_m, CHR_e, PCT_SPACE, CHR_a,
    PCT_SPACE, CHR_b, CHR_e, CHR_a, CHR_u, CHR_t,
    CHR_i, CHR_f, CHR_u, CHR_l, PCT_SPACE, CTR_EM_YELLOW,
    CHR_m, CHR_e, CHR_r, CHR_m, CHR_a, CHR_i,
    CHR_d, CTR_CLOSE_EM, PCT_PERIOD, CTR_ENDLINE};

// {waitinput}{end}{endline}
static s16 scenario_text_09A9[] = {CTR_WAITINPUT, CTR_END, CTR_ENDLINE};
...
s32 scenario_code_message_176_2ad4[] = {
    ...
    // 2b58: Print Text
    TXT,
    (s32)&scenario_text_006D,

    // 2b60: Print Text
    TXT,
    (s32)&scenario_text_00A3,
...
s32 scenario_code_message_176_2c2c[] = {
    ...
    // 2c3c: Print Text
    TXT,
    (s32)&scenario_text_0214,

    // 2c44: Print Text
    TXT,
    (s32)&scenario_text_0246,
    ...
    // 2c6c: Print Text
    TXT,
    (s32)&scenario_text_02D4,

    // 2c74: Print Text
    TXT,
    (s32)&scenario_text_0302,
...
s32 scenario_code_message_176_2cb0[] = {
    ...
    // 2cc0: Print Text
    TXT,
    (s32)&scenario_text_03E4,

    // 2cc8: Print Text
    TXT,
    (s32)&scenario_text_0411,
...
s32 scenario_code_message_176_2fe8[] = {
    ...
    // 3000: Print Text
    TXT,
    (s32)&scenario_text_0572,

    // 3008: Print Text
    TXT,
    (s32)&scenario_text_05AC,
...
s32 scenario_code_message_176_301c[] = {
    ...
    // 3068: Print Text
    TXT,
    (s32)&scenario_text_062E,

    // 3070: Print Text
    TXT,
    (s32)&scenario_text_0665,
...
s32 scenario_code_message_176_31ec[] = {
    ...
    // 323c: Print Text
    TXT,
    (s32)&scenario_text_090E,

    // 3244: Print Text
    TXT,
    (s32)&scenario_text_0940,

    // 324c: Print Text
    TXT,
    (s32)&scenario_text_096D,
