...
s32 scenario_code_message_160_c028[] = {
    ...
    // c028: If Flag 028 (Ushiwaka Went to Golden Temple), Jump To @c838
    // Jump if flag 0x28 is SET to @c838
    JFS, 0x28, (s32)&scenario_code_message_160_c838,

    // c034: If Flag 00a (Heard about Zazen Dwarf), Jump To @c6b4
    // Jump if flag 0x0A is SET to @c6b4
    JFS, 0x0A, (s32)&scenario_code_message_160_c6b4,

    // c040: Print Text
    TXT, (s32)&scenario_text_0000,

    // c048: If Flag 029 (Obtained Achilles' Heel), Jump To @c690
    // Jump if flag 0x29 is SET to @c690
    JFS, 0x29, (s32)&scenario_code_message_160_c690,
    ...
    // c08c: Print Text
    TXT, (s32)&scenario_text_0058,

    // c094: Print Text
    TXT, (s32)&scenario_text_0079,
