...
extern void* func_801CC5C8_65F478(void* entity, s32 x, s32 y, s32 width, s32 height);
extern void func_801CC56C_65F41C(void* sprite, s32 x, s32 y, s32 width, s32 height, s32 alpha);
extern void* func_801CB6AC_65E55C(void* sprite, s32 x, s32 y, s32 z, void* data);
 ...
 * based on game state. Creates sprites at positions (0x38, 0x50) and (0x38, 0x7A),
 * applies data and styling, then sets up callbacks and selection handling.
 * 
...
RECOMP_PATCH void func_801CE3B4_661264(void* entity, s32 param) {
    ...
    *((void**)((u8*)entity_offset + 0x1C)) = sprite1;
    ...
    text_element1 = func_801CB6AC_65E55C(sprite1, 0x1A, 0x5, 0xA, "Archipelago Managed");
...
// External function addresses for callback registration
...
extern s32 D_801E9914_67C7C4;          // Current selection index
extern s32 D_801E9918_67C7C8;          // Secondary selection index
