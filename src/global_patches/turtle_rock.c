...
extern void func_8000F5F8_101F8(s32 sound_id, void *param1, f32 x, f32 y, f32 z,
                                f32 param6);
...
extern void func_80218DA8_5D4278(void *entity, s32 param1, s32 param2,
                                 s32 param3);
...
RECOMP_PATCH void func_08000060_725C90(GINNEKO_TASK_W *ginneko, CLS_BG_W *obj)
{
  ...
  if (phase != GINNEKO_PHASE_INIT)
  {
    ...
    case GINNEKO_PHASE_UPDATE:
      ...
      if ((state->sound_played == 0) &&
          !(ginneko->flags & GINNEKO_FLAG_IN_AIR))
      {
        func_8000F5F8_101F8(GINNEKO_BLOOP_SOUND_ID, D_08000860_726490,
      ...
      if (ginneko->flags & GINNEKO_FLAG_TOUCHED)
      {
        ...
        if (should_run_ap_logic())
        {
          ...
          if (location_id_handle[0] != 0 || location_id_handle[1] != 0)
          {
            ...
            u32 location_id =
                rando_access_slotdata_raw_u32_o32(location_id_handle);
            ...
            bool has_local_item =
                rando_get_location_has_local_item(location_id);
          ...
          {
            DEBUG_PRINTF(
                "Flag %d not found in flag_id_to_ap_location_id mapping\n",
                flag_id);
            replace_surprise_pack_scenario(0x064, scenario_code_surprise_pack,
