...
extern void adjust_logical_doors(struct ActorInstance *actor_instance, struct ActorDefinition *resolved_actor_def, unsigned short actor_id, unsigned short actor_data_file_id, int overall_index);
 ...
 * This function handles actor data modification, room-specific instance creation,
 * and actor processing for the randomizer
 */
...
void func_8020D724_5C8BF4_hook()
{
    ...
    for (int overall_index = 0; overall_index < total_instances; overall_index++)
    {
        ...
        // Special handler to determine if its a NEW instance being edited vs something already in the room
