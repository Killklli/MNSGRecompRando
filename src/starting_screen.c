...
void file_selector_watcher(void *entity, s32 param2)
{
    ...
    {
        // recomp_printf("file_selector_watcher: Connected to Archipelago and scouted.\n");
    }
    else
    {
        recomp_printf("file_selector_watcher: Not connected or not scouted. Connected: %s, Scouted: %s\n",
                      connected ? "YES" : "NO",
                      scouted ? "YES" : "NO");
