...
static const s32 local_read_whitelist[] = {
    ...
    0x138, // WALL_FESTIVAL_FISH_KIT - Invisible Wall That Blocks Doors Un
           // Festival Temple North Fish Kit
    0x193, // WALL_MUSICAL_DIAMOND_KEY - Invisible Wall That Blocks Doors Un
           // Musical Castle 2 Diamond Key
    0x194, // WALL_MUSICAL_LEFT_ENTRANCE - Invisible Wall That Blocks Doors Un
           // Musical Castle 2 Left Entrance
    0x195, // WALL_MUSICAL_METAL_BOX - Invisible Wall That Blocks Doors Un
           // Musical Castle 2 Metal Box Lav
    0x197, // WALL_IYO - Invisible Wall That Blocks Doors Un Iyo
    0x198, // WALL_UNKNOWN_0198 (408 decimal) - Invisible Wall That Blocks Doors
           // Un
    0x19C, // WALL_GHOST_ENTRANCE - Invisible Wall That Blocks Doors Un Ghost
           // Toys Entrance
    0x19D  // SWITCH_SHORELINE - Switch - Shoreline
};
static const s32 local_read_whitelist_size =
    sizeof(local_read_whitelist) / sizeof(local_read_whitelist[0]);
...
RECOMP_PATCH s32 func_800240DC_24CDC(s32 flag_id)
{
    ...
    {
        DEBUG_PRINTF(
            "FLAG READ: flag_id=%ld is whitelisted, reading from local game data\n",
            flag_id);
        ...
        {
            DEBUG_PRINTF(
                "FLAG READ: whitelisted flag_id=%ld is outside bounds, returning 0\n",
                flag_id);
            return 0;
        }
    }
