...
OedoZazenLoc_table: Dict[str, LocationData] = {
    ...
    "GoldenTemple - Mini Ebismaru": LocationData(BASE_ID + 6, "GoldenTemple", "Ability"),
...
YamamotoLoc_table: Dict[str, LocationData] = {
    ...
    "YamamotoShrineInterior - Suprise Pack": LocationData(BASE_ID + 61, "YamamotoShrineInterior", "Upgrade"),
...
SanukiLoc_table: Dict[str, LocationData] = {
    ...
    "KiiAwajiIsland - Suprise Pack": LocationData(BASE_ID + 64, "KiiAwajiIsland", "Upgrade"),
...
GhostToysLoc_table: Dict[str, LocationData] = {
    ...
    "GhostToysCastleInvisibleFloor - Suprise Pack": LocationData(BASE_ID + 127, "GhostToysCastleInvisibleFloor", "Upgrade"),
...
FestivalTempleLoc_table: Dict[str, LocationData] = {
    ...
    "FestivalTempleCannonExterior - Suprise Pack": LocationData(BASE_ID + 141, "FestivalTempleCannonExterior", "Upgrade"),
...
GourmetSubmarineLoc_table: Dict[str, LocationData] = {
    ...
    "GourmetSubmarineGiantCrabFight - Suprise Pack": LocationData(BASE_ID + 200, "GourmetSubmarineGiantCrabFight", "Upgrade"),
    ...
    "GourmetSubmarineZeroGravityFightUpper - Suprise Pack": LocationData(BASE_ID + 206, "GourmetSubmarineZeroGravityFightUpper", "Upgrade"),
