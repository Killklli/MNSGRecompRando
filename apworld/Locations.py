...
PotLoc_table: Dict[str, LocationData] = {
    "Kurashiki - Pot 1": LocationData(BASE_ID + 309, "Kurashiki", "Pot of Ryo"),
    "Kurashiki - Pot 2": LocationData(BASE_ID + 310, "Kurashiki", "Pot of Ryo"),
    "Kurashiki - Pot 3": LocationData(BASE_ID + 311, "Kurashiki", "Pot of Ryo"),
    "Kurashiki - Pot 4": LocationData(BASE_ID + 312, "Kurashiki", "Pot of Ryo"),
    "Nagato - Pot 1": LocationData(BASE_ID + 313, "Nagato", "Pot of Ryo"),
    "Nagato - Pot 2": LocationData(BASE_ID + 314, "Nagato", "Pot of Ryo"),
    "FestivalTempleEntrance - Pot 1": LocationData(BASE_ID + 315, "FestivalTempleEntrance", "Pot of Ryo"),
    ...
    "FestivalTempleRearEntranceUpper - Pot 4": LocationData(BASE_ID + 323, "FestivalTempleRearEntranceUpper", "Pot of Ryo"),
    "FestivalTempleRearEntranceUpper - Pot 5": LocationData(BASE_ID + 324, "FestivalTempleRearEntranceUpper", "Pot of Ryo"),
    "FestivalTempleRearEntranceLower - Pot 1": LocationData(BASE_ID + 325, "FestivalTempleRearEntranceLower", "Pot of Ryo"),
    "FestivalTempleRearEntranceLower - Pot 2": LocationData(BASE_ID + 326, "FestivalTempleRearEntranceLower", "Pot of Ryo"),
    "FestivalTempleRearEntranceLower - Pot 3": LocationData(BASE_ID + 327, "FestivalTempleRearEntranceLower", "Pot of Ryo"),
    "FestivalTempleRearEntranceLower - Pot 4": LocationData(BASE_ID + 328, "FestivalTempleRearEntranceLower", "Pot of Ryo"),
    "FestivalTempleRearEntranceLower - Pot 5": LocationData(BASE_ID + 329, "FestivalTempleRearEntranceLower", "Pot of Ryo"),
    "FestivalTempleSpinningSpikeRoom - Pot 1": LocationData(BASE_ID + 330, "FestivalTempleSpinningSpikeRoom", "Pot of Ryo"),
    "FestivalTempleSpinningSpikeRoom - Pot 2": LocationData(BASE_ID + 331, "FestivalTempleSpinningSpikeRoom", "Pot of Ryo"),
    "FestivalTempleSilverKeySplitoff - Pot 1": LocationData(BASE_ID + 332, "FestivalTempleSilverKeySplitoff", "Pot of Ryo"),
    "FestivalTempleSilverKeySplitoff - Pot 2": LocationData(BASE_ID + 333, "FestivalTempleSilverKeySplitoff", "Pot of Ryo"),
    "FestivalTempleIceKunaiRoom - Pot 1": LocationData(BASE_ID + 334, "FestivalTempleIceKunaiRoom", "Pot of Ryo"),
    "FestivalTempleIceKunaiRoom - Pot 2": LocationData(BASE_ID + 335, "FestivalTempleIceKunaiRoom", "Pot of Ryo"),
    "FestivalTempleIceKunaiRoom - Pot 3": LocationData(BASE_ID + 336, "FestivalTempleIceKunaiRoom", "Pot of Ryo"),
    "FestivalTempleRollingDrumsRoom - Pot": LocationData(BASE_ID + 337, "FestivalTempleRollingDrumsRoom", "Pot of Ryo"),
    "FestivalTempleSamuraiNexttoDrums - Pot": LocationData(BASE_ID + 338, "FestivalTempleSamuraiNexttoDrums", "Pot of Ryo"),
    "FestivalTempleMrArrowRoom - Pot": LocationData(BASE_ID + 339, "FestivalTempleMrArrowRoom", "Pot of Ryo"),
    "FestivalTempleSingleEnemyRoom - Pot": LocationData(BASE_ID + 340, "FestivalTempleSingleEnemyRoom", "Pot of Ryo"),
    "FestivalTempleWoodenHallwayLower - Pot": LocationData(BASE_ID + 341, "FestivalTempleWoodenHallwayLower", "Pot of Ryo"),
    "FestivalTempleSamuraiMovingPlatforms - Pot 1": LocationData(BASE_ID + 342, "FestivalTempleSamuraiMovingPlatforms", "Pot of Ryo"),
    "FestivalTempleSamuraiMovingPlatforms - Pot 2": LocationData(BASE_ID + 343, "FestivalTempleSamuraiMovingPlatforms", "Pot of Ryo"),
    "FestivalTempleWoodenHallwayUpper - Pot": LocationData(BASE_ID + 344, "FestivalTempleWoodenHallwayUpper", "Pot of Ryo"),
    "FestivalTempleWoodenHallwayStaircase - Pot": LocationData(BASE_ID + 345, "FestivalTempleWoodenHallwayStaircase", "Pot of Ryo"),
    "FestivalTempleWoodenSilverKeyRoom - Pot": LocationData(BASE_ID + 346, "FestivalTempleWoodenSilverKeyRoom", "Pot of Ryo"),
    "GhostToysCastleUndergroundWaterway - Pot 1": LocationData(BASE_ID + 347, "GhostToysCastleUndergroundWaterway", "Pot of Ryo"),
    "GhostToysCastleUndergroundWaterway - Pot 2": LocationData(BASE_ID + 348, "GhostToysCastleUndergroundWaterway", "Pot of Ryo"),
    "GhostToysCastleUndergroundWaterway - Pot 3": LocationData(BASE_ID + 349, "GhostToysCastleUndergroundWaterway", "Pot of Ryo"),
    "GhostToysCastleUndergroundWaterway - Pot 4": LocationData(BASE_ID + 350, "GhostToysCastleUndergroundWaterway", "Pot of Ryo"),
    "GhostToysCastleThreePotRoom - Pot 1": LocationData(BASE_ID + 351, "GhostToysCastleThreePotRoom", "Pot of Ryo"),
    "GhostToysCastleThreePotRoom - Pot 2": LocationData(BASE_ID + 352, "GhostToysCastleThreePotRoom", "Pot of Ryo"),
    "GhostToysCastleThreePotRoom - Pot 3": LocationData(BASE_ID + 353, "GhostToysCastleThreePotRoom", "Pot of Ryo"),
    "GorgeousMusicCastleWaterRoom - Pot": LocationData(BASE_ID + 354, "GorgeousMusicCastleWaterRoom", "Pot of Ryo"),
    ...
    "GorgeousMusicCastleSlideRoomLower - Pot": LocationData(BASE_ID + 359, "GorgeousMusicCastleSlideRoomLower", "Pot of Ryo"),
    ...
    "GorgeousMusicCastleScaffoldingClimbLower - Pot 2": LocationData(BASE_ID + 363, "GorgeousMusicCastleScaffoldingClimbLower", "Pot of Ryo"),
    "GourmetSubmarineHotChainblockSushi - Pot": LocationData(BASE_ID + 364, "GourmetSubmarineHotChainblockSushi", "Pot of Ryo"),
    "GourmetSubmarineZeroGravityFightLower - Pot": LocationData(BASE_ID + 365, "GourmetSubmarineZeroGravityFightLower", "Pot of Ryo"),
    "GourmetSubmarineGiantCrabFight - Pot 1": LocationData(BASE_ID + 366, "GourmetSubmarineGiantCrabFight", "Pot of Ryo"),
    "GourmetSubmarineGiantCrabFight - Pot 2": LocationData(BASE_ID + 367, "GourmetSubmarineGiantCrabFight", "Pot of Ryo"),
    "GourmetSubmarineWiringRoom - Pot 1": LocationData(BASE_ID + 368, "GourmetSubmarineWiringRoom", "Pot of Ryo"),
    "GourmetSubmarineWiringRoom - Pot 2": LocationData(BASE_ID + 369, "GourmetSubmarineWiringRoom", "Pot of Ryo"),
    "GourmetSubmarineWiringRoom - Pot 3": LocationData(BASE_ID + 370, "GourmetSubmarineWiringRoom", "Pot of Ryo"),
    "GourmetSubmarineWiringRoom - Pot 4": LocationData(BASE_ID + 371, "GourmetSubmarineWiringRoom", "Pot of Ryo"),
    "GourmetSubmarineZeroGravityFightUpper - Pot": LocationData(BASE_ID + 372, "GourmetSubmarineZeroGravityFightUpper", "Pot of Ryo"),
    "MtFujiPotLedge - Pot": LocationData(BASE_ID + 373, "MtFujiPotLedge", "Pot of Ryo"),
    "TunneltoNortheast1 - Pot": LocationData(BASE_ID + 374, "TunneltoNortheast1", "Pot of Ryo"),
    "TunneltoNortheast2 - Pot 1": LocationData(BASE_ID + 375, "TunneltoNortheast2", "Pot of Ryo"),
    "TunneltoNortheast2 - Pot 2": LocationData(BASE_ID + 376, "TunneltoNortheast2", "Pot of Ryo"),
    "UzenTunnel - Pot": LocationData(BASE_ID + 377, "UzenTunnel", "Pot of Ryo"),
    "OedoCastleFoyer - Pot 1": LocationData(BASE_ID + 378, "OedoCastleFoyer", "Pot of Ryo"),
    "OedoCastleFoyer - Pot 2": LocationData(BASE_ID + 379, "OedoCastleFoyer", "Pot of Ryo"),
    "OedoCastleFoyer - Pot 3": LocationData(BASE_ID + 380, "OedoCastleFoyer", "Pot of Ryo"),
    "OedoCastleFoyer - Pot 4": LocationData(BASE_ID + 381, "OedoCastleFoyer", "Pot of Ryo"),
    "OedoCastleFoyer - Pot 5": LocationData(BASE_ID + 382, "OedoCastleFoyer", "Pot of Ryo"),
    "OedoCastleFoyer - Pot 6": LocationData(BASE_ID + 383, "OedoCastleFoyer", "Pot of Ryo"),
    "OedoCastlePotRoom - Pot 1": LocationData(BASE_ID + 384, "OedoCastlePotRoom", "Pot of Ryo"),
    "OedoCastlePotRoom - Pot 2": LocationData(BASE_ID + 385, "OedoCastlePotRoom", "Pot of Ryo"),
    "OedoCastlePotRoom - Pot 3": LocationData(BASE_ID + 386, "OedoCastlePotRoom", "Pot of Ryo"),
    "OedoCastleCongoChest - Pot": LocationData(BASE_ID + 387, "OedoCastleCongoChest", "Pot of Ryo"),
    "OedoCastleFallingPlatformRoom - Pot": LocationData(BASE_ID + 388, "OedoCastleFallingPlatformRoom", "Pot of Ryo"),
    "TosaFields - Pot": LocationData(BASE_ID + 389, "TosaFields", "Pot of Ryo"),
    "TosaBridge - Pot": LocationData(BASE_ID + 390, "TosaBridge", "Pot of Ryo"),
}
