...
# Pot Locations (ALL regions with MN64Items.POT)
PotLoc_table: Dict[str, LocationData] = {
    "Kurashiki - Pot 1": LocationData(BASE_ID + 309, "Kurashiki", "Pot"),
    "Kurashiki - Pot 2": LocationData(BASE_ID + 310, "Kurashiki", "Pot"),
    "Kurashiki - Pot 3": LocationData(BASE_ID + 311, "Kurashiki", "Pot"),
    "Kurashiki - Pot 4": LocationData(BASE_ID + 312, "Kurashiki", "Pot"),
    "Nagato - Pot 1": LocationData(BASE_ID + 313, "Nagato", "Pot"),
    "Nagato - Pot 2": LocationData(BASE_ID + 314, "Nagato", "Pot"),
    "FestivalTempleEntrance - Pot 1": LocationData(BASE_ID + 315, "FestivalTempleEntrance", "Pot"),
    "FestivalTempleEntrance - Pot 2": LocationData(BASE_ID + 316, "FestivalTempleEntrance", "Pot"),
    "FestivalTempleEntrance - Pot 3": LocationData(BASE_ID + 317, "FestivalTempleEntrance", "Pot"),
    "FestivalTempleGoldKeyRoomUpper - Pot": LocationData(BASE_ID + 318, "FestivalTempleGoldKeyRoomUpper", "Pot"),
    "FestivalTempleGoldKeyRoomLower - Pot": LocationData(BASE_ID + 319, "FestivalTempleGoldKeyRoomLower", "Pot"),
    "FestivalTempleRearEntranceUpper - Pot 1": LocationData(BASE_ID + 320, "FestivalTempleRearEntranceUpper", "Pot"),
    "FestivalTempleRearEntranceUpper - Pot 2": LocationData(BASE_ID + 321, "FestivalTempleRearEntranceUpper", "Pot"),
    "FestivalTempleRearEntranceUpper - Pot 3": LocationData(BASE_ID + 322, "FestivalTempleRearEntranceUpper", "Pot"),
    "FestivalTempleRearEntranceUpper - Pot 4": LocationData(BASE_ID + 323, "FestivalTempleRearEntranceUpper", "Pot"),
    "FestivalTempleRearEntranceUpper - Pot 5": LocationData(BASE_ID + 324, "FestivalTempleRearEntranceUpper", "Pot"),
    "FestivalTempleRearEntranceLower - Pot 1": LocationData(BASE_ID + 325, "FestivalTempleRearEntranceLower", "Pot"),
    "FestivalTempleRearEntranceLower - Pot 2": LocationData(BASE_ID + 326, "FestivalTempleRearEntranceLower", "Pot"),
    "FestivalTempleRearEntranceLower - Pot 3": LocationData(BASE_ID + 327, "FestivalTempleRearEntranceLower", "Pot"),
    "FestivalTempleRearEntranceLower - Pot 4": LocationData(BASE_ID + 328, "FestivalTempleRearEntranceLower", "Pot"),
    "FestivalTempleRearEntranceLower - Pot 5": LocationData(BASE_ID + 329, "FestivalTempleRearEntranceLower", "Pot"),
    "FestivalTempleSpinningSpikeRoom - Pot 1": LocationData(BASE_ID + 330, "FestivalTempleSpinningSpikeRoom", "Pot"),
    "FestivalTempleSpinningSpikeRoom - Pot 2": LocationData(BASE_ID + 331, "FestivalTempleSpinningSpikeRoom", "Pot"),
    "FestivalTempleSilverKeySplitoff - Pot 1": LocationData(BASE_ID + 332, "FestivalTempleSilverKeySplitoff", "Pot"),
    "FestivalTempleSilverKeySplitoff - Pot 2": LocationData(BASE_ID + 333, "FestivalTempleSilverKeySplitoff", "Pot"),
    "FestivalTempleIceKunaiRoom - Pot 1": LocationData(BASE_ID + 334, "FestivalTempleIceKunaiRoom", "Pot"),
    "FestivalTempleIceKunaiRoom - Pot 2": LocationData(BASE_ID + 335, "FestivalTempleIceKunaiRoom", "Pot"),
    "FestivalTempleIceKunaiRoom - Pot 3": LocationData(BASE_ID + 336, "FestivalTempleIceKunaiRoom", "Pot"),
    "FestivalTempleRollingDrumsRoom - Pot": LocationData(BASE_ID + 337, "FestivalTempleRollingDrumsRoom", "Pot"),
    "FestivalTempleSamuraiNexttoDrums - Pot": LocationData(BASE_ID + 338, "FestivalTempleSamuraiNexttoDrums", "Pot"),
    "FestivalTempleMrArrowRoom - Pot": LocationData(BASE_ID + 339, "FestivalTempleMrArrowRoom", "Pot"),
    "FestivalTempleSingleEnemyRoom - Pot": LocationData(BASE_ID + 340, "FestivalTempleSingleEnemyRoom", "Pot"),
    "FestivalTempleWoodenHallwayLower - Pot": LocationData(BASE_ID + 341, "FestivalTempleWoodenHallwayLower", "Pot"),
    "FestivalTempleSamuraiMovingPlatforms - Pot 1": LocationData(BASE_ID + 342, "FestivalTempleSamuraiMovingPlatforms", "Pot"),
    "FestivalTempleSamuraiMovingPlatforms - Pot 2": LocationData(BASE_ID + 343, "FestivalTempleSamuraiMovingPlatforms", "Pot"),
    "FestivalTempleWoodenHallwayUpper - Pot": LocationData(BASE_ID + 344, "FestivalTempleWoodenHallwayUpper", "Pot"),
    "FestivalTempleWoodenHallwayStaircase - Pot": LocationData(BASE_ID + 345, "FestivalTempleWoodenHallwayStaircase", "Pot"),
    "FestivalTempleWoodenSilverKeyRoom - Pot": LocationData(BASE_ID + 346, "FestivalTempleWoodenSilverKeyRoom", "Pot"),
    "GhostToysCastleUndergroundWaterway - Pot 1": LocationData(BASE_ID + 347, "GhostToysCastleUndergroundWaterway", "Pot"),
    "GhostToysCastleUndergroundWaterway - Pot 2": LocationData(BASE_ID + 348, "GhostToysCastleUndergroundWaterway", "Pot"),
    "GhostToysCastleUndergroundWaterway - Pot 3": LocationData(BASE_ID + 349, "GhostToysCastleUndergroundWaterway", "Pot"),
    "GhostToysCastleUndergroundWaterway - Pot 4": LocationData(BASE_ID + 350, "GhostToysCastleUndergroundWaterway", "Pot"),
    "GhostToysCastleThreePotRoom - Pot 1": LocationData(BASE_ID + 351, "GhostToysCastleThreePotRoom", "Pot"),
    "GhostToysCastleThreePotRoom - Pot 2": LocationData(BASE_ID + 352, "GhostToysCastleThreePotRoom", "Pot"),
    "GhostToysCastleThreePotRoom - Pot 3": LocationData(BASE_ID + 353, "GhostToysCastleThreePotRoom", "Pot"),
    "GorgeousMusicCastleWaterRoom - Pot": LocationData(BASE_ID + 354, "GorgeousMusicCastleWaterRoom", "Pot"),
    "GorgeousMusicCastleDancinWarp - Pot": LocationData(BASE_ID + 355, "GorgeousMusicCastleDancinWarp", "Pot"),
    "GorgeousMusicCastleConveyorBeltRoom - Pot": LocationData(BASE_ID + 356, "GorgeousMusicCastleConveyorBeltRoom", "Pot"),
    "GorgeousMusicCastleWindowHallway - Pot": LocationData(BASE_ID + 357, "GorgeousMusicCastleWindowHallway", "Pot"),
    "GorgeousMusicCastleSlideRoomUpper - Pot": LocationData(BASE_ID + 358, "GorgeousMusicCastleSlideRoomUpper", "Pot"),
    "GorgeousMusicCastleSlideRoomLower - Pot": LocationData(BASE_ID + 359, "GorgeousMusicCastleSlideRoomLower", "Pot"),
    "GorgeousMusicCastleScaffoldingClimbUpper - Pot 1": LocationData(BASE_ID + 360, "GorgeousMusicCastleScaffoldingClimbUpper", "Pot"),
    "GorgeousMusicCastleScaffoldingClimbUpper - Pot 2": LocationData(BASE_ID + 361, "GorgeousMusicCastleScaffoldingClimbUpper", "Pot"),
    "GorgeousMusicCastleScaffoldingClimbLower - Pot 1": LocationData(BASE_ID + 362, "GorgeousMusicCastleScaffoldingClimbLower", "Pot"),
    "GorgeousMusicCastleScaffoldingClimbLower - Pot 2": LocationData(BASE_ID + 363, "GorgeousMusicCastleScaffoldingClimbLower", "Pot"),
    "GourmetSubmarineHotChainblockSushi - Pot": LocationData(BASE_ID + 364, "GourmetSubmarineHotChainblockSushi", "Pot"),
    "GourmetSubmarineZeroGravityFightLower - Pot": LocationData(BASE_ID + 365, "GourmetSubmarineZeroGravityFightLower", "Pot"),
    "GourmetSubmarineGiantCrabFight - Pot 1": LocationData(BASE_ID + 366, "GourmetSubmarineGiantCrabFight", "Pot"),
    "GourmetSubmarineGiantCrabFight - Pot 2": LocationData(BASE_ID + 367, "GourmetSubmarineGiantCrabFight", "Pot"),
    "GourmetSubmarineWiringRoom - Pot 1": LocationData(BASE_ID + 368, "GourmetSubmarineWiringRoom", "Pot"),
    "GourmetSubmarineWiringRoom - Pot 2": LocationData(BASE_ID + 369, "GourmetSubmarineWiringRoom", "Pot"),
    "GourmetSubmarineWiringRoom - Pot 3": LocationData(BASE_ID + 370, "GourmetSubmarineWiringRoom", "Pot"),
    "GourmetSubmarineWiringRoom - Pot 4": LocationData(BASE_ID + 371, "GourmetSubmarineWiringRoom", "Pot"),
    "GourmetSubmarineZeroGravityFightUpper - Pot": LocationData(BASE_ID + 372, "GourmetSubmarineZeroGravityFightUpper", "Pot"),
    "MtFujiPotLedge - Pot": LocationData(BASE_ID + 373, "MtFujiPotLedge", "Pot"),
    "TunneltoNortheast1 - Pot": LocationData(BASE_ID + 374, "TunneltoNortheast1", "Pot"),
    "TunneltoNortheast2 - Pot 1": LocationData(BASE_ID + 375, "TunneltoNortheast2", "Pot"),
    "TunneltoNortheast2 - Pot 2": LocationData(BASE_ID + 376, "TunneltoNortheast2", "Pot"),
    "UzenTunnel - Pot": LocationData(BASE_ID + 377, "UzenTunnel", "Pot"),
    "OedoCastleFoyer - Pot 1": LocationData(BASE_ID + 378, "OedoCastleFoyer", "Pot"),
    "OedoCastleFoyer - Pot 2": LocationData(BASE_ID + 379, "OedoCastleFoyer", "Pot"),
    "OedoCastleFoyer - Pot 3": LocationData(BASE_ID + 380, "OedoCastleFoyer", "Pot"),
    "OedoCastleFoyer - Pot 4": LocationData(BASE_ID + 381, "OedoCastleFoyer", "Pot"),
    "OedoCastleFoyer - Pot 5": LocationData(BASE_ID + 382, "OedoCastleFoyer", "Pot"),
    "OedoCastleFoyer - Pot 6": LocationData(BASE_ID + 383, "OedoCastleFoyer", "Pot"),
    "OedoCastlePotRoom - Pot 1": LocationData(BASE_ID + 384, "OedoCastlePotRoom", "Pot"),
    "OedoCastlePotRoom - Pot 2": LocationData(BASE_ID + 385, "OedoCastlePotRoom", "Pot"),
    "OedoCastlePotRoom - Pot 3": LocationData(BASE_ID + 386, "OedoCastlePotRoom", "Pot"),
    "OedoCastleCongoChest - Pot": LocationData(BASE_ID + 387, "OedoCastleCongoChest", "Pot"),
    "OedoCastleFallingPlatformRoom - Pot": LocationData(BASE_ID + 388, "OedoCastleFallingPlatformRoom", "Pot"),
    "TosaFields - Pot": LocationData(BASE_ID + 389, "TosaFields", "Pot"),
    "TosaBridge - Pot": LocationData(BASE_ID + 390, "TosaBridge", "Pot"),
}
...
all_locations.update(PotLoc_table)
