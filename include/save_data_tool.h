...
// Function includes from flag management module
#include "flag_management/ap_datastorage.h"
...
#define READ_SAVE_DATA(offset) (*(s32 *)(D_8015C608_15D208 + (offset)))

// Read 16-bit values from save data at specified offset
#define READ_SAVE_DATA_H(offset) (*(s16 *)(D_8015C608_15D208 + (offset)))

// Read 8-bit values from save data at specified offset
#define READ_SAVE_DATA_B(offset) (*(u8 *)(D_8015C608_15D208 + (offset)))
...
#define IS_FLAG_SET(flag_id) ((*(u8 *)(D_8015C608_15D208 + ((flag_id) / 8)) & (1 << ((flag_id) % 8))) != 0)
