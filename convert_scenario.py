...
CHAR_MAP = {
    ...
    'z': 'CHR_z', 'A': 'CHR_A', 'B': 'CHR_B', 'C': 'CHR_C', 'D': 'CHR_D',
    'E': 'CHR_E', 'F': 'CHR_F', 'G': 'CHR_G', 'H': 'CHR_H', 'I': 'CHR_I',
    'J': 'CHR_J', 'K': 'CHR_K', 'L': 'CHR_L', 'M': 'CHR_M', 'N': 'CHR_N',
    'O': 'CHR_O', 'P': 'CHR_P', 'Q': 'CHR_Q', 'R': 'CHR_R', 'S': 'CHR_S',
    'T': 'CHR_T', 'U': 'CHR_U', 'V': 'CHR_V', 'W': 'CHR_W', 'X': 'CHR_X',
    'Y': 'CHR_Y', 'Z': 'CHR_Z', ' ': 'PCT_SPACE', '!': 'PCT_EXCLAMATION',
    '"': 'PCT_DOUBLEQUOTE', "'": 'PCT_APOSTROPHE', ',': 'PCT_COMMA',
    '.': 'PCT_PERIOD', ':': 'PCT_COLON', ';': 'PCT_SEMICOLON',
    '?': 'PCT_QUESTION', '-': 'PCT_HYPHEN', '(': 'PCT_OPENPAREN',
    ')': 'PCT_CLOSEPAREN', '/': 'PCT_SLASH',
}
